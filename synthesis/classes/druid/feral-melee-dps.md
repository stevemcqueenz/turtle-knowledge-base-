...
- **BiS lists**: Bayanni's Kara40/Naxx cat list (Forgotten Hide Helm, Shieldrender Talisman, Felforged Nathrezan Veil, Tunic of Demonic Deception, Leggings of the Apocalypse, Might of Menethil, Atiesh) [Bayanni, 2025-04-27](https://forum.turtlecraft.gg/viewtopic.php?p=128749#p128749) vs. Noephix's rebuttal that only ~3 pieces replace AQ40 items [Noephix, 2025-05-16](https://forum.turtlecraft.gg/viewtopic.php?p=131289#p131289) — **contested**; the shared consensus is "we still use the same old AQ40 gear" (Noephix 2025-05-30). Shieldrender was changed in 1.18.1 ("a huge nerf for feral Druid. Currently I can get 3 autos and maybe 1-2 abilities during the three second window", player reply in t23973, post-announcement).
