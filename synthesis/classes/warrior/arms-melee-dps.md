...
| Improved Charge | 2/2 | "actually beneficial" (1.18.1-thread player, see Sources); leveling: at least 1 point so Charge gives enough rage for Hamstring/Pummel [Xudo (player), 2024-11-02](https://forum.turtlecraft.gg/viewtopic.php?p=105917#p105917) |
...
7. **Heroic Strike** only at ≥ 70 rage with nothing else available (Wolf of Rage); "Arms doesn't want to use Heroic Strike" (1.18.1-thread player).
...
- Using Rend at 60 in raids ("no warriors are still not using rend in their rotation as their is literally no incentive for it" [player, f70 1.17.2 thread]) — Rend is a leveling/PvP tool.
...
| 1.18.1 thread [p=171512 area] | player "floating 1" post | 2026-03-20 | post-1.18.1 | tree criticism (post id: see gap in README) |
