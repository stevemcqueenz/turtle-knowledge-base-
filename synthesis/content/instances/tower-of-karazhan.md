...
| **Affinities** (adds) | **One per magic school — fire, frost, shadow, nature and arcane — each of which must be killed by damage of its own school inside a short window.** Health varies per school (adjusted separately on PvP realms); they now despawn on death. A player puts the requirement at "40k HP in 15 seconds" per affinity | *(official)* [Torta (staff), 2025-04-08](https://forum.turtlecraft.gg/viewtopic.php?p=126056#p126056), [Torta (staff), 2025-04-22](https://forum.turtlecraft.gg/viewtopic.php?p=128053#p128053); *(player, the numbers and the school list)* [Sirracha (player), 2025-04-13](https://forum.turtlecraft.gg/viewtopic.php?p=126572#p126572), [Sirracha (player), 2025-04-13](https://forum.turtlecraft.gg/viewtopic.php?p=126634#p126634) |
| **Incantagos Curse** | Increases mana cost by **300 %**; must be cleansed | *(player)* [Cysthen (player), 2025-04-24](https://forum.turtlecraft.gg/viewtopic.php?p=128282#p128282) |
...
**The raid-composition controversy (the best-documented tactics argument about Kara40).** A top-10-guild raid leader called the fight "poorly designed": "This boss requires a raid to have **5+ caster dps of every element (fire, frost, shadow, nature, arcane)**… Stop trying to force people to play caster dps" — [Sirracha (player), 2025-04-13](https://forum.turtlecraft.gg/viewtopic.php?p=126572#p126572).

**Staff answered directly, and this is the only staff statement about a Kara40 encounter's requirements in the extraction:** "Just as a point of information: **the boss has been downed with as low as 2 on some elements, and with 3 on all**" — [Akalix (staff), 2025-04-13](https://forum.turtlecraft.gg/viewtopic.php?p=126582#p126582).

The thread then produced the practical answer, from a player who had killed it: **you do not need five casters per element — healers and hybrids count.** "For instance holy priests help on shadow, ferals and resto druid helping on nature etc" — [Hadjo (player), 2025-04-13](https://forum.turtlecraft.gg/viewtopic.php?p=126644#p126644). The raid leader's counter is that paladin healers contribute nothing to any school and that not every guild has six resto shamans, two holy priests and two resto druids — [Sirracha (player), 2025-04-13](https://forum.turtlecraft.gg/viewtopic.php?p=126648#p126648); he also disputes the staff figure and says guilds "just reset the fight until they get the elements that are in their favor" — [Sirracha (player), 2025-04-13](https://forum.turtlecraft.gg/viewtopic.php?p=126634#p126634). **Contested; staff and one successful raider on one side, the complainant on the other.**

Two knock-on effects players report: guilds asking members to reroll, with a fully geared Naxx warrior bowing out of Kara40 because he could not contribute — [Piccolo1833 (player), 2025-04-16](https://forum.turtlecraft.gg/viewtopic.php?p=127004#p127004) — and a server-wide shortage: "Around 15–30 guilds looking for the same geared caster dps… Around 1000 casters missing from the population" — [Templar85 (player), 2025-04-17](https://forum.turtlecraft.gg/viewtopic.php?p=127094#p127094). One player defends the design as forcing elitist guilds to accept off-meta specs — [amanagor (player), 2025-04-13](https://forum.turtlecraft.gg/viewtopic.php?p=126657#p126657).

The Affinities mechanic also makes this one of the fights where shamans use school-specific play; a player names Incantagos and Chromaggus as the only fights where a particular school-swap tool matters — *(player)* [Kokuyoo (player), 2026-02-16](https://forum.turtlecraft.gg/viewtopic.php?p=168435#p168435). Incantagos also drops a healing ring that players complain went unchanged in a balance pass — *(player)* [Elleshar (player), 2025-05-13](https://forum.turtlecraft.gg/viewtopic.php?p=130905#p130905).
...
- **Loot-table sizes (player, from the in-game database):** Mephistroth has 14 items, "5 of which are a 6 % chance and the other 9 at 8 % chance"; **Kruul has 9 items** on his table while **Sanv Tas'dal and Rupturan have 7 each**. The same player notes Kruul drops both "the best 2h axe in the game" and Shieldrender Talisman while Rupturan's drops are underwhelming — [Melvorforum (player), 2025-11-16](https://forum.turtlecraft.gg/viewtopic.php?p=159824#p159824), agreed by [Wsta (player), 2025-11-16](https://forum.turtlecraft.gg/viewtopic.php?p=159828#p159828).
- **Token yield (player, one week's observation):** "2 boots tokens from Chess, 1 shoulder and 1 neck from Sanv, 2 head tokens from Rupturan, 2 legs tokens from Kruul and 2 chest tokens from Mephistroth. Near the same amount of tokens as from AQ40" — [Melvorforum (player), 2025-11-16](https://forum.turtlecraft.gg/viewtopic.php?p=159824#p159824).
- **Leather gear complaint (player):** "Why are gauntlets from Rupturan not even an upgrade over AQ40 gauntlets…? Why is leather belt from FINAL BOSS worse for cat than belt from a friggin C'Thun?" — with only three exceptions named: the helm from Sanv Tas'dal, and the chest and the heart-turn-in cloak from Mephistroth — [Noephix (player), 2025-04-23](https://forum.turtlecraft.gg/viewtopic.php?p=128135#p128135), [Noephix (player), 2025-04-24](https://forum.turtlecraft.gg/viewtopic.php?p=128287#p128287).
...
- **No health or damage numbers** for any Tower of Karazhan boss. Every wiki boss page is a stub; staff notes say "slightly reduced", "increased", "modified" without values. The hard numbers in the extraction are: Shifting Rock's 3000 armor, the 2.5 s cast times on Shackles of the Legion / Nathrezim Terror, Ephemeral Pendant's 20 % drop chance, Incantagos Curse's 300 % mana-cost increase, the player-reported "40k HP in 15 seconds" per Incantagos Affinity, and the loot-table sizes and drop chances in §3 — all but the first three from players.
- **No player-written boss guide** for Kara40 exists in this extraction — no equivalent of the Emerald Sanctum hard-mode write-up. The Incantagos raid-composition thread (§2) is the only encounter discussed in tactical detail; everything else is assembled from class threads and staff notes. This remains the largest tactics gap in the instance set relative to the raid's importance.
- **Trash linking:** players note most Kara40 trash is not linked to its boss and propose pairings (Gnarlmoon = the worgen mobs at the start, Incantagos = Manascale Overseer, Anomalus = Arcane Overflows, Medivh = the Librarians) — [Lyssebabz2 (player), 2026-02-20](https://forum.turtlecraft.gg/viewtopic.php?p=168980#p168980). No staff response.
