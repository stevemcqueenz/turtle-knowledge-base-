...
| **Protection** | A (contested) | Very tanky in PvE gear; wins 1v4 against physical classes [[d:paladin#1490470082948632746]]; a nerf is expected [[d:paladin#1490470328374399117]] |
| **Retribution (SoC)** | B | Burst through Judgement of Command and crits; no gap closer, purgeable seals, low Stamina gear [[d:paladin#1481664240270970996]], [[d:paladin#1441760867635953716]] |
| **Retribution (SoR spellret)** | C | "Spellret doesnt have enough stam to do anything in pvp" [[d:paladin#1441146500938731622]]; "SoR is way less bursty then SoC, usually pvp is about burst" [[d:paladin#1441525444099837992]] |
| **Shockadin / Holy-Prot** | C for kills, B for survival | "Sticky and hard to kill", creates distractions, but does not kill much [[d:paladin#1423413036584276019]]; damage and healing dampening make niche builds even weaker [[d:paladin#1469979336156250299]] |
...
- **Judgement of Justice now taunts** (Lhian) [[d:paladin#1481428000867356684]]; a small utility buff, "no amount of dampening will fix the shit utility and impotence of a ret in a battlefield" (Excinerus) [[d:paladin#1481547155540807691]].
- **Repentance** ticks with 8% of attack power on immune targets ([Jamey (staff)](https://forum.turtlecraft.gg/viewtopic.php?p=166071#p166071)).
- **Divine Shield** also cuts healing: "Divine Shield now reduces healing taken and done by 50%" [[d:paladin#1467173434726547698]] (another player reports 60% [[d:paladin#1454939206445957152]]). **Contested** exact value.
- Earlier Turtle PvP nerfs that still apply: Hand of Sacrifice no longer breaks crowd control, Hand of Freedom has a longer cooldown and shorter duration [[d:paladin#1441767886023692468]], [[d:paladin#1487223373317542039]]; the HoS/HoF changes "were justified via pvp data afaik" [[d:paladin#1482822720457670656]].
- **Arena:** opened after the patch [[d:paladin#1484570635874078914]]; Lay on Hands is disabled in arena [[d:paladin#1441426127284473877]], and Divine Shield is switched off in rated arena [[d:paladin#1489382932161495110]].

## Builds

### Retribution: Seal of Command PvP, 11/8/32 (recommended Ret)

The raid SoC build with **Improved Seal of the Crusader moved to Deflection**: "you're never ever using seal of the crusader in pvp" [[d:paladin#1438896892590424166]]; "Those people taking Crusader points should be taking Parry instead. And they use SoC because PvP is mostly about burst" [[d:paladin#1477090352065151047]].
...
Split **11/8/32**, validated (VALID). [Open in talent calculator](https://xian55.github.io/tortoise-db-viewer/?talents=paladin&t=5500001-503-0520305113005151) · code `FoAAB-FAY-AoQYFJYAFIFAB`

- Beldrin's PvP split is **17/0/34** (more Holy, no Protection) [[d:paladin#1438896184516149339]]; "PvP specs are very personal" [[d:paladin#1438896478016770138]].
- **Repentance is mandatory:** "I could never pvp without repentance, shits too valueable" [[d:paladin#1465252136186155038]].
- **Sanctity Aura in PvP is contested:** "sanct aura in pvp is placebo" (Excinerus) because auras get purged and dispelled; Jesse Potter would rather off-heal [[d:paladin#1423429381895753759]], [[d:paladin#1423430942047080549]].

### Retribution: self-healing bruiser, 10/7/34 (single source)

For world PvP and small skirmishes without a dedicated healer. Reconstructed from dindunuffinz's description: "enough points to get repentance, rest can probably go into holy for spiritual focus and holy judgement for those busted 1.5s holy lights", with Guardian's Favor in Protection and warrior-style AP gear [[d:paladin#1460039423646240779]]. Jesse Potter describes the same idea: Ret with Repentance, then Holy healing talents for pushback resistance, with Concentration Aura and Ironclad [[d:paladin#1438858260546588769]], "if you're doing pvp / open world elites with a friend and don't have a healer dedicated" [[d:paladin#1438858149003264110]]. The Protection row-1 opener (Improved Devotion Aura) and the exact Retribution points are this guide's fill.
...
| Protection | Improved Devotion Aura | 5/5 |
| Protection | Guardian's Favor | 2/2 |
| Retribution | Benediction | 5/5 |
| Retribution | Improved Judgement | 2/2 |
| Retribution | Deflection | 5/5 |
| Retribution | Conviction | 5/5 |
...
Split **10/7/34**, validated (VALID). [Open in talent calculator](https://xian55.github.io/tortoise-db-viewer/?talents=paladin&t=5032-5002-0520505023005151) · code `FAa-FAC-AoQoFCYAFIFAB`

Holy Judgement makes the next Holy Light cast in 1.5 s; the PvP channel calls the talent "mandatory for real" [[d:pvp-general#1427672117058474138]].

### Holy: Blessed Strikes healer, 38/0/13

Mithreon's standard Holy build [[d:paladin#1489299128310693929]]; "I think pvp will still favor the Blessed Strikes build for hpal" [[d:paladin#1431256800099045406]]. The talent details and the PvE side are on the [Holy](holy.md) page.
...
Split **38/0/13**, validated (VALID). [Open in talent calculator](https://xian55.github.io/tortoise-db-viewer/?talents=paladin&t=05320312005251351--502300012) · code `AoaAZQFQpAYoB--FATAAK`

A PvP-focused Holy player's 35-point Holy core adds 3/3 Improved Concentration Aura and 2/2 Unyielding Faith (fear resistance) instead of Improved Lay on Hands and Sanctity Aura [[d:paladin#1487416064835846296]]. Spiritual Focus + Concentration Aura gives 105% pushback resistance [[d:pvp-general#1430590994587586620]].

### Holy: Shockadin, 38/8/5 (reconstructed)

Shokisan's PvP and solo spec: "Deep Holy/Precision enough to make melee combat more effective", with a shield, "so super duper strong in pvp and solo questing" [[d:paladin#1487616709295603844]], [[d:paladin#1487616480571822153]]; the split is 38/8/5 [[d:paladin#1474454905497452717]]. The Holy 38 below is Mithreon's Holy tree; Redoubt 5 + Precision 3 follow Shokisan's description; the 5 Retribution points (Improved Blessings) are this guide's fill.

| Tree | Talent | Points |
|---|---|---|
| Holy | (same 38 points as the Blessed Strikes build) | 38 |
| Protection | Redoubt | 5/5 |
| Protection | Precision | 3/3 |
| Retribution | Improved Blessings | 5/5 |

Split **38/8/5**, validated (VALID). [Open in talent calculator](https://xian55.github.io/tortoise-db-viewer/?talents=paladin&t=05320312005251351-053-5) · code `AoaAZQFQpAYoB-AoY-F`

**Contested:** Shockadin is fun and tanky but low on damage: "just heal in PvP and let actual good classes do dmg" [[d:paladin#1488212884839469197]]. If you do spec Holy Shock, go further into the reset talent and consider Blessing of Sanctuary, which "basically deletes rogues, cats and fury warriors" [[d:paladin#1490468741014618153]], [[d:paladin#1490472253706604746]].

### Protection: deep Prot, 11/33/7

Silverhand plays "deep prot with TF" in PvE tank gear [[d:paladin#1490469775988494518]]. The reference deep-Prot tree is the raid build (see [Protection](protection.md)):

Split **11/33/7**, validated (VALID). [Open in talent calculator](https://xian55.github.io/tortoise-db-viewer/?talents=paladin&t=0500501-0530331302031351-052) · code `AoAoB-AoYDZYCAZYAoB-AoQ`

- Swap in Libram of Final Judgement to execute targets under 35% [[d:paladin#1481665621958725803]].
- Improved Hammer of Justice (Protection) brings Hammer of Justice to a 30 s cooldown "like kidney" [[d:paladin#1484653064366325761]].
- Weakness: Dissolvent poison ignores Block; only dodge and parry mitigate it [[d:paladin#1435717695189422100]].

## Stats and gear

- **Stamina matters more than in PvE.** "bis and pre-bis sets for ret pretty much don't account for survivability at all beyond the barest minimum" [[d:paladin#1441524752610099302]]. Holy wants 6k+ health [[d:paladin#1481664712130166965]].
...
- **Weapon: Icy Chill** ("Icy chill BiS enchant") [[d:pvp-general#1430556900088610846]]; "the slow has unironically been just enough to stop people getting away" [[d:pvp-general#1427585100068950076]].
- **Frost Oil** on top: "If you're not using Frost Oils, you are only making things worse on yourself and your team. They cost nothing" [[d:paladin#1483206998899163288]]; 100% uptime is possible [[d:pvp-general#1430589399329935470]].
- Stronghold Gauntlets against disarms [[d:pvp-general#1430582780810494034]].
- Engineering grenades and sappers ([Leveling: professions](leveling.md#professions-while-leveling)).

## Burst and control

**The basic battleground loop** (dindunuffinz): seal up, find your Freedom button, **Repentance into Hammer of Justice**, Crusader Strike [[d:pvp-general#1429284370241552527]]; "effective in hands of even a braindead 10iq" [[d:pvp-general#1429283974500450405]].

**SoC burst window:**

1. Stun the target (Hammer of Justice, or a Seal of Justice proc).
2. **Judgement of Command** deals double damage on stunned targets [[d:paladin#1435043535899590837]]; with a slow weapon, "if you get lucky and get a triple crit your target is dead in a global" [[d:paladin#1435043642799558746]].
3. Keep Seal of Command up for the autos; SoC now procs on about 1 in 2 swings [[d:paladin#1465012850329391263]].

**Against healers:** Ret has no interrupt besides Hammer of Justice and Repentance, so Seal of Justice is "the only 'interrupt' you have outside HoJ and Repentance" [[d:paladin#1426723808445989067]], [[d:pvp-general#1430216235202777238]]. Judging Justice can proc the seal on the Judgement hit, a ranged stun; re-seal Justice and judge again [[d:paladin#1491170906700251276]].

**Against several rogues** (Jesse Potter): trinket the Kidney Shot, bubble or BoP, Repentance and hope they trinket it, then Hammer of Justice, or wait out Evasion [[d:paladin#1426122717635285005]].

**Repentance notes:** it breaks on damage, unlike a fear [[d:paladin#1426800158305419428]]; Berserker Rage breaks it [[d:pvp-general#1433888687392817154]]; it no longer delays a Free Action-potioned flag carrier [[d:paladin#1430425762976235651]]. Only Hammer of Justice and Repentance can be reflected; the rest of your kit is Holy damage, not Holy spells [[d:paladin#1432486314611314698]], [[d:paladin#1432486241823363276]].

**Defensive tools:**

- **Divine Shield**: "when the paladin pops his bubble, consider not hitting them for 12 seconds straight" [[d:paladin#1487132791127675094]]; use it to disengage or to eat a Kidney Shot and save your trinket [[d:paladin#1429823453028155465]].
- **Blessing of Protection** makes you immune to Blind (Blind is not a poison on Turtle) [[d:paladin#1424408436044595280]].
- **Hand of Freedom, stuns and seals are magic and purgeable** [[d:paladin#1441760867635953716]]; Shamans can purge your seal, while their own weapon imbues cannot be removed [[d:pvp-general#1424861028696723568]].
- The class has no innate slow or movement speed ("wheelchair") [[d:pvp-general#1432018758431408371]].
...
The sources contain little PvP macro text. Useful from the PvE pages: the Seal + Judgement one-button macro and the Holy Might strike selector ([Retribution: macros and addons](retribution.md#macros-and-addons)). Excinerus suggests a macro that "casts CS if your health is below a threshold and holy shock is on CD, and holy strike otherwise" (to fish for a Holy Shock reset) [[d:paladin#1457176499038715914]]; no macro text was posted.

## Common mistakes

1. **Playing SoR spellret in PvP**: no Stamina and no burst [[d:paladin#1441146500938731622]], [[d:paladin#1441525444099837992]].
2. **Taking Improved Seal of the Crusader** or keeping Crusader up [[d:paladin#1438896892590424166]].
3. **Wearing PvE BiS without extra Stamina** [[d:paladin#1441524752610099302]].
4. **Skipping Frost Oil and Icy Chill** [[d:paladin#1483206998899163288]].
5. **Hitting a bubbled paladin** instead of switching [[d:paladin#1487132791127675094]].
6. **Relying on Hand of Sacrifice to break crowd control**: it no longer does [[d:paladin#1441767886023692468]].
