...
| **Destruction (Fire)** | **Contested** ("A" to "wheelchair") | Burst with slows, stuns and crits secures kills vs kiting classes. But: no Curse of Exhaustion and everything is hard-cast | For: [[d:warlock#1487531377367711785]], [[d:warlock#1494966922104537178]]. Against: [[d:warlock#1487499992615882772]] |
| **Demonology** | **B** | Great in duels and arenas (greater demons "can't be cc'd and will one shot every spec"); weak in battlegrounds, where one Fear, Banish or Hamstring on your pet wastes your cooldowns | [[d:warlock#1447378022100635658]], [[d:warlock#1469459298722775227]], [[d:warlock#1461931073293521128]] |
...
### Affliction 35/5/11 (recommended)

Afraido's PvP recommendation [[d:warlock#1485611980990447658]]. It is identical to Ghost9626's PvP build [[d:warlock#1436492032876085399]].

| Tree | Talent | Points |
|---|---|---|
| Affliction | Improved Corruption | 5/5 |
| Affliction | Resilient Shadows | 3/3 |
| Affliction | Improved Drains | 2/2 |
| Affliction | Improved Curse of Agony | 3/3 |
| Affliction | Fel Concentration | 2/2 |
| Affliction | Curse of Exhaustion | 1/1 |
...
| Affliction | Improved Curse of Exhaustion | 2/2 |
...
- **Fel Concentration 2/2** also stops pushback on Fear and Howl of Terror [[d:warlock#1405907548908949636]].
- **Curse of Exhaustion 1/1 + Improved 2/2** is the reason to play the spec; without the improvement it is only a 10% slow [Jamey (staff), 2025-07-25](https://forum.turtlecraft.gg/viewtopic.php?p=141159#p141159).
...
- **The PvE Tier 2.5 ("Dark Harvest") set bonus also matters in PvP:** it adds a stacking burst effect that ramps with your Shadow Vulnerability stacks over a fight, landing roughly 1,400 extra damage "at the end" on top of Dark Harvest's own ~400-450 [[d:pvp-general#1432881383466074186]], [[d:pvp-general#1432881054900949012]].
- **Rank-8 PvP gloves** plus Intensity give 105% pushback protection on Searing Pain [[d:warlock#1378758822390140970]].
- **Trinkets:** Zandalarian Hero Charm or Restrained Essence of Sapphiron, reflectors, and a PvP trinket [[d:warlock#1062445024341655644]]. Everyone swaps trinkets constantly [[d:warlock#1329378303659737193]]. The PvP trinket also breaks stuns [[d:warlock#1312397951850512457]].
- **Enchants:** stamina-first and cheap: 100 HP chest, ZG head and legs, Sapphiron shoulders, spell-power bracers [[d:warlock#1282473381857329228]].
- **Stones:** **Spellstone** removes all magic buffs and debuffs from you, including magical silences [[d:warlock#1454095765600473179]]. It is "giga strong against sp, warlocks and mages" [[d:warlock#1209940014520336435]]. It shares the Healthstone cooldown.
- **Consumables:** Free Action Potion, Flask of the Titans, arcane bombs [[d:warlock#1394677049758584832]]. Limited Invulnerability Potions and the Voidwalker's Sacrifice deny a warrior rage [[d:warlock#1411574992134738042]]. Greater Holy Protection Potions against paladins [Erhog, 2023-11-27](https://forum.turtlecraft.gg/viewtopic.php?p=78940#p78940).
- **Engineering** is the PvP profession: grenades, reflectors, rocket boots and helmet [[d:warlock#1285479733110509580]], [[d:warlock#1419960348370534450]]. The Cloaking Device trinket keeps you invisible while you cast (e.g. a Soul Fire), unlike an Invisibility Potion, which breaks on cast [[d:pvp-general#1428147579186839582]], [[d:pvp-general#1428151260850290768]].

## Pets

| Pet | Use | Sources |
|---|---|---|
| **Felhunter** | Default. Spell Lock on the enemy healer ("10% dmg << 8sec silence on enemy healer"), Devour Magic, Paranoia against stealth. Keep it on manual; bait Counterspell by faking a Drain Soul or opening with a fire spell | [[d:warlock#1476314060005048532]], [[d:warlock#1435740919579152524]] |
| **Succubus** | Seduction CC, "best pvp pet by far" for 3v1 kills. Turn off Lash of Pain autocast, which cancels Seduction. Seduction breaks if she is in melee range of the target | [[d:warlock#1457487764894384189]], [[d:warlock#1465198561955418367]], [[d:warlock#1457464148341424381]] |
| **Voidwalker** | Situational: its Sacrifice shield against warriors (no damage taken means no rage) and burst | [[d:warlock#1416231530354708601]], [[d:warlock#1465083633282060443]] |
| **Imp** | Blood Pact; stays at range when melee would kill other pets | [[d:warlock#1465082548748288010]] |
| **Greater demons** | Arena and duel win condition (Inferno and Demon Gate reset each match). Cannot be brought reliably into world PvP. Felguard's cooldown is short enough when talented (~15 min) to summon it almost twice in a single WSG, but it is "super inconsistent" in arenas: terrain can wall it off entirely (e.g. standing on the pillar in Blade's Edge Arena), which does not work against melee comps. Ret Paladin + Felguard Warlock is rated a possible best-in-slot 2v2 arena comp, since the paladin's Divine Protection and Hand of Protection counter enemy warlocks | [[d:warlock#1436498300542128168]], [[d:warlock#1464911531757015155]], [[d:pvp-general#1423771270083772597]], [[d:pvp-general#1433530820173238426]], [[d:pvp-general#1433531063644459049]], [[d:pvp-general#1433954955731140648]] |
| **Doomguard** | "Silly OP" in duels: charges, applies a Mortal-Strike-like effect and stuns; its ranged axe-throw is a knockdown that cannot be trinketed. Counter: Disarm it to shut off its melee damage. Being a demon (not Undead) also means a paladin's fear-like CC (loosely called "shackle undead" in the channel) cannot touch it, since that spell only affects Undead-type targets | [[d:pvp-general#1423981432631464006]], [[d:pvp-general#1423981685447327865]], [[d:pvp-general#1423992600020385822]], [[d:pvp-general#1433506786140487740]], [[d:pvp-general#1433507432889581569]] |

Rule of thumb: "succubus is great vs rogues, felhunter vs casters, vw can work vs warriors" [[d:warlock#1412421339352137758]].

## Control and burst sequences

**Fear rules:** Seduction shares diminishing returns with Fear, but fear-breaking effects do not break it [[d:warlock#1424132365671993464]]. On Turtle, Will of the Forsaken gives 3 s of immunity instead of 5 [[d:warlock#1424135596372263005]]. Many Horde PvP players are Undead, so the non-Fear tools matter [[d:warlock#1485611672000266320]]. Curse of Recklessness now has a 1 s GCD, which makes it "the best pvp spell u can cast" for fear-juggling: it stops a feared target from fleeing until you swap curses [[d:warlock#1490124423288717403]], [[d:warlock#1490139514566344975]].

**Curse pick, contested:** one player calls Curse of Shadow (5 min, -70 resistance, +10% shadow damage taken, castable on many targets) stupidly strong for PvP; Verlyn disagrees — he says Curse of Tongues, Exhaustion, Elements or no curse at all is usually the better pick, and he uses Curse of Shadow almost exclusively on enemy Felhunters to lower their shadow resistance before Banishing them [[d:pvp-general#1428341868940365937]], [[d:pvp-general#1428363605560266865]].

**Useful tricks:** a Healthstone can be handed to an ally roughly every 2 minutes [[d:pvp-general#1424812942028832929]]. Fel Domination cuts pet-summon cast time to 1.5 s, useful for a fast re-pet after a kill or a death [[d:pvp-general#1425009815138340914]]. Soulstone-into-Shadow Bolt (rezzing an ally straight into a nuke) is called "a killer combo" [[d:pvp-general#1425013983236329562]].

**Affliction kite (default):**

1. Curse of Exhaustion on the melee target.
2. Corruption, Curse of Agony, Siphon Life (all instant) [[d:warlock#1464376560290107628]].
3. Walk away and let the DoTs work. Drain Life or Drain Soul while they are slowed. Without a dispel, Dark Harvest can put about 5k damage through a single Fear in about 7 s [[d:warlock#1450363160979570840]].
4. Fear or Howl of Terror when they close; Death Coil as the emergency peel.
5. Shadowburn or Nightfall Shadow Bolt to finish.
...
| Opponent | Verdict | How | Sources |
|---|---|---|---|
| **Warrior** | Favoured if you keep range | Curse of Exhaustion before Charge, Death Coil, walk. The Voidwalker shield and LIP deny rage | [[d:warlock#1331017705658122240]], [[d:warlock#1416231530354708601]], [[d:pvp-general#1351160314342936608]] |
| **Rogue** | Hard; easy as Affliction with a trinket | They open, you trinket → Death Coil → double Fear → Curse of Exhaustion → DoTs → drain. Without a trinket: Seduce when they jump you, or catch them in stealth with the Felhunter | [[d:warlock#1479969109692125224]], [[d:warlock#1479969431651352821]], [[d:pvp-general#1358235113535574017]] |
...
| **Warlock** | Pet and CC race | Felhunter Devour Magic plus Spell Lock. A Succubus-spec opponent is close to unbeatable 1v1 without a Restoration or Lucidity Potion: the fight comes down to killing their Succubus before she seduces again, otherwise you get chain-seduced into a Soul Fire | [[d:warlock#1348439442708496435]], [[d:pvp-general#1426343844731162684]], [[d:pvp-general#1426343965292236901]] |
| **2+ melee** | Losing | No mobility, a 2-minute Death Coil, and Fear as your only peel | [[d:warlock#1399432909311574158]] |

## Battlegrounds

- **Sit at max range and do your PvE rotation.** Standing close to Curse of Tongues casters gets you killed [[d:warlock#1451420578169753755]].
- **Arathi Basin:** be a time-waster at a node. Fear, Seduce and DoTs can hold 3 players [[d:warlock#1389422988415471656]].
...
| Race | PvP value | Source |
|---|---|---|
| **Undead** | Best PvP racial: Will of the Forsaken (3 s immunity on Turtle). Its +2% damage to humanoids does not work on players | [[d:warlock#1491111022877216972]], [[d:warlock#1424135596372263005]], [[d:warlock#1491164815488450784]] |
| **Orc** | Blood Fury: +120 spell power for 15 s ("basically a free trinket") and +5% pet damage. The stun-resist racial was nerfed hard | [[d:warlock#1491110311535706296]], [[d:warlock#1491111022877216972]] |
| **Troll** | Affliction pick | [[d:warlock#1488865404519583745]] |
| **Gnome, Human** | Gnome and Forsaken top Summonjutsu's list; Human is third for Perception against rogue and druid openers | [[d:warlock#1455821507870724242]] |
| **Goblin** | Sprint as an escape; otherwise middling | [[d:warlock#1488440903084539956]] |

Alliance warlocks have it harder: "if you play alliance like me you can't fear in pvp either" [[d:warlock#1491580899484110919]]. Dwarf warlocks (new in 1.18.1) have no PvP evaluation in the sources.

**Contested:** dindunuffinz argues a warlock is disproportionately valuable and rare on Alliance, and that Curse of Tongues is especially strong there because Horde's caster-heavy comps rely on mage/druid decurses to clear it [[d:pvp-general#1427356050306109440]], [[d:pvp-general#1427356400962637824]]; Kyrsie disputes it — "if warlock was really that useful on alliance we would see more of them" [[d:pvp-general#1427356582261555452]].

## Macros

- Pet ability buttons that survive pet swaps: `/script CastSpellByName("Sacrifice")`, `("Seduction")`, `("Spell Lock")` [[d:warlock#1479235229880156311]].
- Defensive Devour Magic on mouseover or yourself [[d:warlock#1453784754527666186]]:
  ```
  /script if nil then CastSpellByName("Devour Magic"); end
  /cast [@mouseover, help] Devour Magic; [@player] Devour Magic
  ```
- Nightfall-only Shadow Bolt macro (checks the proc buff) [[d:warlock#1469634727521554485]].

## Common mistakes

- Fighting at melee range, or hard-casting Shadow Bolt on a melee target.
- Opening Fear on an Undead player before they have used Will of the Forsaken.
- Leaving Lash of Pain on autocast, so Seduction gets cancelled.
- Burning a greater demon in a battleground where a single Fear or Banish wastes it [[d:warlock#1469459298722775227]].
- Destruction against a fire-reflector or fire-immunity target [[d:warlock#1469458947969909015]].
- Using Death Coil early and having no peel when the rogue re-opens.
