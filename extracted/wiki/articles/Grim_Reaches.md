---
title: "Grim Reaches"
url: "https://turtle-wow.fandom.com/wiki/Grim_Reaches"
source_type: "community wiki (turtle-wow.fandom.com), not an official source"
revision: "2026-03-29T17:11:05Z"
fetched: "2026-09-10T07:38:55Z"
is_turtle_content: true
patch: "1.18.0"
categories: ["Eastern Kingdoms", "Grim Reaches", "Turtle WoW content"]
---
# Grim Reaches
...
| faction | Neutral |
| level | 33 - 38 |
| capital | Dun Kithas, Shatterblade Post |
| races | Wildhammer dwarf, Orc, Dark Iron dwarf, Murloc |
| rulers | Council of Dun Kithas, Commander Aggnash, Korlag Doomsong |
| major | Ruins of Stolgaz Keep, Zarm'geth Stronghold |
| minor | Slatebeard's Forge, Baggoth's Wall, East Ridge Outpost, Baggoth's Rampart |
...
### Elite areas
- [Zarm'geth Stronghold](Zarm'geth Stronghold)

### Travel hubs
#### [Flight path](Flight path)s from [Dun Kithas](Dun Kithas)
- [Thelsamar](Thelsamar), [Loch Modan](Loch Modan)

#### [Flight path](Flight path)s from [Shatterblade Post](Shatterblade Post)
...
|-
| [Loch Modan](Loch Modan) ||  || 10-20 || Southwest|| By foot through the [High Pass](High Pass) or by flight path from [Dun Kithas](Dun Kithas) to [Thelsamar](Thelsamar).
|-
| [Wetlands](Wetlands) ||  || 20-25 || West|| By foot through the [Dragonmaw Gates](Dragonmaw Gates).
|-
|}
