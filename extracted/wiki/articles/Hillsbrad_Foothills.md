...
url: "https://turtle-wow.fandom.com/wiki/Hillsbrad_Foothills"
source_type: "community wiki (turtle-wow.fandom.com), not an official source"
revision: "2026-03-24T15:16:32Z"
fetched: "2026-09-10T07:38:59Z"
is_turtle_content: false
patch: null
categories: ["Eastern Kingdoms", "Hillsbrad Foothills", "Human territories"]
---
# Hillsbrad Foothills
...
| ss | Hillsbrad Foothills.jpg |
| faction | Neutral |
| level | 20 - 30 |
| capital | Southshore, Tarren Mill |
| races | Human, Forsaken, Naga, Murloc, Gnoll |
| rulers | Magistrate Henry Maleb, Magistrate Rutherford Burnside, High Executor Darthalia |
| loc | Central-southern Lordaeron |
| major | Hillsbrad Fields, Dun Garok, Durnholde Keep |
| affiliation | Forsaken, Horde, Alliance, Syndicate, Mudsnout tribe, Daggerspine, Torn Fin tribe |
| faffiliation | Kingdom of Lordaeron, Alliance of Lordaeron |

The **Hillsbrad Foothills** (or **Hillsbrad Plains**) (ref: Markers in [Arathi Highlands](Arathi Highlands) and [Silverpine Forest](Silverpine Forest)) is a large region of the former [kingdom of Lordaeron](Lordaeron (kingdom)) and is mostly untouched by the [Scourge](Scourge). It was here that the first battle took place between the forces of the [Alliance of Lordaeron](Alliance of Lordaeron) and the [Orcish Horde](Orcish Horde) during the [Second War](Second War). Located in the southern end of the continent of Lordaeron, the hills are home to the towns of [Southshore](Southshore) and [Hillsbrad Fields](Hillsbrad Fields) for the [Alliance](Alliance), and [Tarren Mill](Tarren Mill) for the [Horde](Horde). Some notable locations, such as [Durnholde Keep](Durnholde Keep) and [Azurelode Mine](Azurelode Mine) can also be found here. Since this area lies outside of [Thoradin's Wall](Thoradin's Wall), it is considered as a crossroads between Alliance and Horde players, which makes combat between the two factions likely.
...
There are no instanced dungeons or battlegrounds in the foothills, though the [Alterac Valley](Alterac Valley) battleground can be found in the nearby [Alterac Mountains](Alterac Mountains). In addition, the micro dungeon [Purgation Isle](Purgation Isle) can be found here.
...
### Travel hubs
##### [Flight path](Flight path)s from [Southshore](Southshore)
- [Ironforge](Ironforge), [Dun Morogh](Dun Morogh)
- [Menethil Harbor](Menethil Harbor), [The Wetlands](Wetlands)
...
##### [Flight path](Flight path)s from [Tarren Mill](Tarren Mill)
...
|-
| [Silverpine Forest](Silverpine Forest) ||  || 10-20 || West || By foot or Horde flight path from Tarren Mill to the Sepulcher.
|-
| [Alterac Mountains](Alterac Mountains) ||  || 30-40 || North || By foot only.
|-
| [Arathi Highlands](Arathi Highlands) ||  || 30-40 || East || By foot or by flight paths from Tarren Mill to Hammerfall or from Southshore to Refuge Pointe.
|-
| [Gilneas](Gilneas) ||  || 39-46 || Southwest || By swimming from the southwestern coast, or by flight path from [Southshore](Southshore) to [Ravenshire](Ravenshire) or from [Tarren Mill](Tarren Mill) to [Stillward Church](Stillward Church).
|-
| [The Hinterlands](Hinterlands) ||  || 40-50 || Northeast || By foot, or by flight paths from Tarren Mill to Revantusk Village or from Southshore to Aerie Peak.
|-
|}
