---
title: "Silithid"
url: "https://turtle-wow.fandom.com/wiki/Silithid"
source_type: "community wiki (turtle-wow.fandom.com), not an official source"
revision: "2025-12-04T18:13:56Z"
fetched: "2026-09-10T07:39:38Z"
is_turtle_content: false
patch: null
categories: ["Creatures", "Pages with broken file links", "Silithid"]
---
# Silithid

## History
Before the [Sundering](Sundering), [Kalimdor](Kalimdor), the ancient continent of eternal starlight, was a nurturing mother to all of its creatures. 
At the continent's center was a mysterious lake of incandescent energies, the [Well of Eternity](Well of Eternity). It was the true heart of the world's magic and natural power. From this magical ether the **Silithid** were born. As the fallen [Old God](Old God) [C'Thun](C'Thun) recognized their appearance, he attempted to sunder the world that it once held in its unmerciful grasp. The Old God created avatars from the Silithid in its own image. These avatars were called the [Azi Aqir](Azi Aqir), who later split up into the [Qiraji](Qiraji) and the [Nerubian](Nerubian)s. Sentient and with thousands of years the Qiraji worked feverishly to build a force capable of laying waste to the world that would betray their god with the Silithids as their minions.
...
Each of the three [Hives](Hives) in Silithus has a crystalline prism in it. They are apparently a means for the Qiraji and other unknown entities to communicate various messages to the silithid.

## Locations
The Silithids burrow their underground hives all over southern Kalimdor. All of [Silithus](Silithus) is under their control, and they have hives in [Feralas](Feralas), [Tanaris](Tanaris), [Un'Goro Crater](Un'Goro Crater), and the [Shimmering Flats](Shimmering Flats). They've even been sighted in small numbers in [The Barrens](The Barrens).
...
## See Also
- [:Category:Silithid](:Category:Silithid)
