---
title: "Archmage Angela Dosantos"
url: "https://turtle-wow.fandom.com/wiki/Archmage_Angela_Dosantos"
source_type: "community wiki (turtle-wow.fandom.com), not an official source"
revision: "2025-12-23T09:13:36Z"
fetched: "2026-09-10T07:38:20Z"
is_turtle_content: false
patch: null
categories: ["Argent Dawn", "Brotherhood of the Light", "Dalaran (kingdom)", "Deceased characters", "Eastern Plaguelands NPCs", "Human characters", "Kirin Tor", "Mage characters", "Quest givers"]
---
...
| image | Archmage Angela Dosantos.png |
| titles | Archmage,, Brotherhood of the Light |
| faction | Neutral |
| affiliation | Brotherhood of the Light, Argent Dawn |
| faffiliation | Dalaran, Kirin Tor |
| occupation | Archmage of the Brotherhood of the Light |
| foccupation | Watcher of Atiesh, Greatstaff of the Guardian |
| level | 60 |
| type | Elite |
| aggro |  |
| race | Human |
...
She first joined the Argent Dawn in order to help prevent [Kel'Thuzad](Kel'Thuzad) from gaining control of Atiesh, and has since been enrolled in the Brotherhood of the Light in order to pursue this goal more aggressively. However, when brought the rebuilt [Frame of Atiesh](Frame of Atiesh), she is driven to her death by [Sargeras' corruption](Atiesh (demon)) in the staff's frame, with her passing confirmed by [Anachronos](Anachronos).
...
- [quest: Frostfire Gloves|class=mage] 
- [quest: Frostfire Sandals|class=mage] 
- [quest: Frostfire Belt|class=mage] 
- [quest: Frostfire Bindings|class=mage] 
- [quest: Frostfire Shoulderpads|class=mage] 

## Quotes
### Gossip about Atiesh
It is said that [Kel'Thuzad](Kel'Thuzad) seeks the legendary Atiesh, greatstaff of the Guardian.

Yes, the very staff once held by [Medivh](Medivh).

> Gossip: What is Atiesh?

Like Kel'Thuzad, I too was once a mage of the [Kirin Tor](Kirin Tor). And like Kel'Thuzad, I seek the legendary Atiesh, greatstaff of the Guardian. Our fates are intertwined as such, <class>.

> Gossip: What Guardian? I don't understand any of this.

Progeny of [Aegwynn](Aegwynn), he that would be the last Guardian of Tirisfal... Medivh.

> Gossip: Please continue.
...
> Gossip: This is disturbing. Please continue.
...
### Core of elements
> Gossip: Where can I find core of elements?

Ah, a good question.

If you prefer hunting in the great outdoors, there are elementals here in the Plaguelands, Azshara, Burning Steppes, Felwood, Silithus, Winterspirng, and even Un'goro Crater.

If you are the type that laughs in the face of danger, then perhaps you should visit Dire Maul. I have heart that a great many elemental abberations[sic] exist within its walls. You would also do well in seeking out the elementals employed by the Dark Iron dwarves of Blackrock Depths.
...
### Talking to Angela with the [Frame of Atiesh](Frame of Atiesh)
  **Archmage Angela Dosantos says:** What have you done? FOOL! You brought it... NO!
  *Archmage Angela Dosantos runs outside of the chapel.*
   Archmage Angela Dosantos scratches at her throat.
