---
title: "Gadgetzan"
url: "https://turtle-wow.fandom.com/wiki/Gadgetzan"
source_type: "community wiki (turtle-wow.fandom.com), not an official source"
revision: "2026-03-25T15:45:02Z"
fetched: "2026-09-10T07:38:50Z"
is_turtle_content: false
patch: null
categories: ["Articles using deprecated loot", "Goblin territories", "Pages with broken file links", "Tanaris subzones"]
---
# Gadgetzan
...
| faction | Neutral |
| leader |  |
| race | Goblin, Gnome, Human, Dwarf, Orc |
| language | Goblin, Common, Gnomish |
| affiliation | Steamwheedle Cartel |
| loc | Northern Tanaris |
| facilities | Yes |
| inn | Yes |
| mailbox | Yes |
| stables | Yes |
...
## General Information
Although the goblins' neutrality is almost universally acknowledged, there are still those who seek to sow chaos and anarchy. For Gadgetzan, this comes in the form of the [Wastewander](Wastewander) bandits, a gang of miscreants who have occupied the [Waterspring Field](Waterspring Field) and [Noonshade Ruins](Noonshade Ruins) of northeast Tanaris. Few goblins care about ancient ruins (unless they have treasure) – for all they care, the bandits can have the old blocks of stone.
...
### Facilities
- The world-famous universal [Auction House](Auction House). Anyone can trade here regardless of faction or affiliation!
- A handy [Bank](Bank). Sit in the wonderfully soft and luxurious waiting area while you wait for a teller to become available.
- High-quality [Forge](Forge) & [Anvil](Anvil) for any [blacksmithing](blacksmithing) buffs out there. Used even by the [Mithril Order](Mithril Order).
- The renowned [Inn](Inn), nice hammocks and soft beds for people of all shapes and sizes. Continental breakfast for additional price.
- The friendly [Stable Master](Stable Master) who will gladly take care of your animal needs.
- Out the north gate &mdash; a [Wyvern](Wyvern) handler for the friendly [Horde](Horde) &mdash; to the south a [Gryphon](Gryphon) master for the amiable [Alliance](Alliance) folk.
- Alchemists and engineers aplenty for those who wish to brush up on their skills.
- A teleportation pad for quick and safe arrival for those who have the [Ultrasafe Transporter: Gadgetzan](Ultrasafe Transporter: Gadgetzan).
- A members-only discothèque, according to [Rohan the Assassin](Rohan the Assassin).

### The Cage
In the center of Gadgetzan is a cage. It has one door on the north side. The walls of the cage block the neutral guards' line-of-sight, allowing Horde and Alliance to [gank](gank) or otherwise slaughter each other to their content within it. However this must have been changed in a recent patch. If you try to fight inside the cage the guards will run in and beat you to a pulp!
...
Players who've specialized in [Gnomish Engineering](Gnomish Engineering) can build a gadget that can teleport them directly to Gadgetzan.

## Gaining Favor
Killing the [Southsea Pirates](Southsea Pirates) and [Wastewander](Wastewander) nomads will increase your [Reputation](Reputation) with the [:Steamwheedle Cartel](:Steamwheedle Cartel).  Having a [Friendly](Friendly) or higher Reputation will make the Guards help you in case of initiated violence against you.
...
| colspan=2 |
| colspan=6 |
| colspan=1 |First: 150, Following: 10
|  x5
|-
| colspan=8 |
| colspan=1 |25
...
| colspan=3 |
| colspan=1 |5
| colspan=1 |15 Rep for Named NPCs
|-
| colspan=8 |
| colspan=1 |2.5
| colspan=1 |12.5 Rep for Named NPCs
|-
| colspan=8 |
| colspan=1 |1
...
See [Mobs which affect reputation with Steamwheedle Cartel](Mobs which affect reputation with Steamwheedle Cartel).
...
After completing , you will have access to  and . The former is available if you are unable to complete the field sampling in under two hours.
...
### Zul'Farrak
- [quest: Scarab Shells] - from [Tran'rek](Tran'rek)
- [quest: Troll Temper] - from [Trenton Lighthammer](Trenton Lighthammer)
- [quest: Divino-matic Rod] - from [Chief Engineer Bilgewhizzle](Chief Engineer Bilgewhizzle)

## An article from the *[Gadgetzan Times](Gadgetzan Times)*
