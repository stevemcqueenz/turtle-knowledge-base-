...
url: "https://turtle-wow.fandom.com/wiki/Cathedral_of_Light"
source_type: "community wiki (turtle-wow.fandom.com), not an official source"
revision: "2025-12-12T18:44:38Z"
fetched: "2026-09-10T07:38:30Z"
is_turtle_content: false
patch: null
categories: ["Buildings", "Crypts", "Human territories", "Pages with broken file links", "Paladins", "Priests", "Stormwind City subzones", "Temples"]
---
# Cathedral of Light
...
[Priest](Priest)s and paladins travel to the cathedral from far and wide seeking training and wisdom from their resident counterparts. [High Priestess Laurena](High Priestess Laurena) is the highest ranking priest trainer in Stormwind City and [Lord Grayson Shadowbreaker](Lord Grayson Shadowbreaker) is the foremost paladin trainer. [Brother Crowley](Brother Crowley) is always looking for possible recruits for the [Scarlet Crusade](Scarlet Crusade) and also acts as the Crusade's emissary to the archbishop.

The Cathedral is also the most common place for human [roleplaying](roleplaying) players to marry since it so greatly resembles a church.

There is a hidden way downstairs to the basement in the room, one of each side of the altar, entering the Cathedral. The basement (or catacombs) contains a library and a general catacomb. There are no guards there, and Alliance players rarely venture down, so it is a popular place for Horde raids. A warlock and two rogues usually sneak down there to summon an entire raid, thus taking the city by surprise.
