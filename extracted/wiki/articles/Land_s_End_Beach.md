...
url: "https://turtle-wow.fandom.com/wiki/Land%27s_End_Beach"
source_type: "community wiki (turtle-wow.fandom.com), not an official source"
revision: "2025-11-30T12:29:49Z"
fetched: "2026-09-10T07:39:07Z"
is_turtle_content: false
patch: null
categories: ["Articles using deprecated loot", "Pages with broken file links", "Shores", "Tanaris subzones"]
---
# Land's End Beach
...
This was once believed to be an undeveloped [Undermine](Undermine), the [goblin](goblin) city of much importance in lore, but now (as of [patch 1.8](Patch 1.8 (Release Notes))) believed to be the [South Seas islands](South Seas islands) included in [the Scepter of the Shifting Sands quest chain](the Scepter of the Shifting Sands quest chain).

## Inspiration
This [subzone](subzone) is *possibly* a reference to [Land's End](Wikipedia:Land's End) in England, the southwestern tip of the British mainland.
