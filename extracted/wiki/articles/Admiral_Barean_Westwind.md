...
url: "https://turtle-wow.fandom.com/wiki/Admiral_Barean_Westwind"
source_type: "community wiki (turtle-wow.fandom.com), not an official source"
revision: "2025-09-01T20:36:44Z"
fetched: "2026-09-10T07:38:16Z"
is_turtle_content: true
patch: "1.16.0"
categories: ["Human characters", "Kul Tiras (kingdom)", "Scarlet Crusade", "Scarlet Enclave mobs", "Turtle WoW content"]
---
# Admiral Barean Westwind

| field | value |
|---|---|
| name | Admiral Barean Westwind |
| image | Admiral Barean Westwind.png |
| titles | Grand Admiral of the Scarlet Fleet |
| faction | Combat |
| affiliation | Scarlet Crusade, Kul Tiras |
| level | 60 |
| type | Rare Elite |
| aggro |  |
| race | Human |
...
- [Fleet Scimitar](Fleet Scimitar)
- [Westwind's Bicorne](Westwind's Bicorne)
- [Sash of the Northrend Expedition](Sash of the Northrend Expedition)
- [Sivaxis Tundra Shard](Sivaxis Tundra Shard)
- [Mariner's Cuffs](Mariner's Cuffs)
- [The Frigid Star Ring](The Frigid Star Ring)
- [Jacket of the Scarlet Admiral](Jacket of the Scarlet Admiral)

## Hall of Champions Plaque
## Patch changes
