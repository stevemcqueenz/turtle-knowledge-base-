---
title: "Gnome (playable)"
url: "https://turtle-wow.fandom.com/wiki/Gnome_(playable)"
source_type: "community wiki (turtle-wow.fandom.com), not an official source"
revision: "2025-05-27T06:02:35Z"
fetched: "2026-09-10T07:38:52Z"
is_turtle_content: false
patch: null
categories: ["Alliance races", "Gnomes", "Ironforge"]
---
# Gnome (playable)

*This article is about the playable race. For the gnome lore, see [Gnome](Gnome). For the in-game faction, see [Gnomeregan Exiles](Gnomeregan Exiles).*

The **gnomes** of the [Gnomeregan Exiles](Gnomeregan Exiles) are one of the playable [Alliance](Alliance) races in *World of Warcraft*. A brilliant race of inventors, the gnomes have enjoyed a friendship with their dwarven cousins for generations, with who they shared the subterranean spaces of Khaz Modan. However, their kingdom was lost to invasion and betrayal, and in recent years gnomes have lived in the halls of their allies.

Gnomes start out with their dwarven cousins in [Dun Morogh](Dun Morogh)'s [Coldridge Valley](Coldridge Valley). The gnomes do not currently have a capital city, although they dream of the day that their beloved [Gnomeregan](Gnomeregan) will be fully reclaimed, and the [Gnomeregan Reclamation Facility](Gnomeregan Reclamation Facility) is where High Tinker [Gelbin Mekkatorque](Gelbin Mekkatorque) leads efforts to retake their lost city. They ride Mechanostrider mounts and speak Gnomish as their main language, with Common as a secondary tongue.
...
|- class="alt"
! style="text-align:left" |Expansive Mind - passive
|-
|Intelligence increased by 5%.||
|- class="alt"
! style="text-align:left" |Engineering Specialization - passive
|-
|Engineering skill increased by 15.||
|- class="alt"
! style="text-align:left" |Disassembler - passive
|-
|Damage dealt versus Mechanicals increased by 5%.||
|- class="alt"
|}
