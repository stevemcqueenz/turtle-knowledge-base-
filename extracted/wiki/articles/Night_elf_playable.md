---
title: "Night elf (playable)"
url: "https://turtle-wow.fandom.com/wiki/Night_elf_(playable)"
source_type: "community wiki (turtle-wow.fandom.com), not an official source"
revision: "2025-05-26T07:36:19Z"
fetched: "2026-09-10T07:39:19Z"
is_turtle_content: false
patch: null
categories: ["Alliance races", "Night elves"]
---
# Night elf (playable)

*This article is about the playable race. For the night elf lore, see [Night elf](Night elf). For the in-game faction, see [Darnassus (faction)](Darnassus (faction)).*

The **night elves** of Darnassus are one of the playable [Alliance](Alliance) races in *World of Warcraft*. Amongst the oldest races on Azeroth, this ancient people saw the world nearly sundered by their own reckless use of magic. Forsaking the primal magics of their past, the elves then went on to live harmoniously with nature. After thousands of years in isolation, the night elves eventually made contact with the younger races and found common goals alongside them, resulting in their Alliance with the races of men, dwarves, and gnomekind.

They start in [Shadowglen](Shadowglen), an area located inside the great tree Teldrassil. The elven capital is [Darnassus](Darnassus), where their High Priestess [Tyrande Whisperwind](Tyrande Whisperwind) and Archdruid [Fandral Staghelm](Fandral Staghelm) lead their people. The night elves has long rode the mighty nightsaber, and their racial language is Darnassian. The Common tongue is a secondary language they share with their allies.

For the [Alliance](Alliance), the [druid](druid) class is exclusive to the night elves.
...
! style="text-align:left" |Shadowmeld - instant - 1 min cooldown
|-
|Activate to slip into the shadows, reducing the chance for enemies to detect your presence. Lasts until cancelled or moving and remains active for 2 sec after either action.||
|- class="alt"
! style="text-align:left" |Quickness - passive
|-
|Increases your attack speed, casting speed, movement speed and dodge chance by 1%.||
|- class="alt"
! style="text-align:left" |Nature Resistance - passive
|-
|Nature resistance increased by 10.||
|- class="alt"
! style="text-align:left" |Wisp Spirit - passive
|-
