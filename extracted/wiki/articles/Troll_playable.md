---
title: "Troll (playable)"
url: "https://turtle-wow.fandom.com/wiki/Troll_(playable)"
source_type: "community wiki (turtle-wow.fandom.com), not an official source"
revision: "2026-05-12T22:52:01Z"
fetched: "2026-09-10T07:39:53Z"
is_turtle_content: true
patch: "1.17.0"
categories: ["Horde races", "Trolls", "Turtle WoW content"]
---
# Troll (playable)

*This article is about the playable race. For the jungle troll lore, see [Jungle troll](Jungle troll). For the in-game faction, see [Darkspear Trolls](Darkspear Trolls).*

The **trolls** of the [Darkspear tribe](Darkspear tribe) are one of the playable [Horde](Horde) races in *World of Warcraft*. Trolls are an ancient and widespread people, with most living savage, crude lifestyles and attacking other races on sight. The Darkspears originally hailed from the jungles of [Stranglethorn](Stranglethorn Vale), but after being pushed out by warring tribes, they found an unlikely friendship with the orcs and sailed with them to new lands. Prior to Cataclysm, due to a traitor having taken control of their intended home, trolls started out alongside orcs in the Valley of Trials. This changed when the Darkspears at long last reclaimed Darkspear Isle, which is now where they begin their adventures.

Young trolls start out in the [Valley of Trials](Valley of Trials) along with the orcs, and [Sen'jin Village](Sen'jin Village) serves as a capital of sorts for the tribe (albeit a small one). The troll racial mount is a raptor, and their language is Troll. They have also learned orcish to communicate with their allies.
...
! style="text-align:left" |Berserking - instant - 3 min cooldown
|-
|Increases your attack and casting speed by 10% to 15%. At full health the speed increase is 10% with a greater effect up to 15% if you are badly hurt when you activate Berserking. Lasts 10 sec.||
|- class="alt"
! style="text-align:left" |Beast Slaying - passive
|-
|Damage dealt versus Beasts increased by 5%.||
|- class="alt"
! style="text-align:left" |Bow Specialization - passive
|-
|Skill with Bow Weapons increased by 3.||
|- class="alt"
! style="text-align:left" |Throwing Specialization - passive
|-
|Skill with Throwing Weapons increased by 3.||
|- class="alt"
! style="text-align:left" |Regeneration - passive
|-
|Health regeneration rate increased by 20%. 25% of total Health regeneration may continue during combat.||
|- class="alt"
|}
...
- (Patch 1.17.0|note=Trolls now have access to the warlock class.)
