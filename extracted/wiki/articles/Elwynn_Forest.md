---
title: "Elwynn Forest"
url: "https://turtle-wow.fandom.com/wiki/Elwynn_Forest"
source_type: "community wiki (turtle-wow.fandom.com), not an official source"
revision: "2026-03-29T17:06:00Z"
fetched: "2026-09-10T07:38:43Z"
is_turtle_content: false
patch: null
categories: ["Eastern Kingdoms", "Elwynn Forest", "Forests", "Human territories", "Starting areas"]
---
# Elwynn Forest
...
|---|---|
| name | Elwynn Forest |
| ss | Elwynn Forest.jpg |
| faction | Alliance |
| level | 1 - 10 |
| capital | Stormwind City |
| races | Human, High elf, Dwarf, Gnome, Gnoll, Kobold, Murloc |
| rulers |  |
| loc | Northwestern Azeroth |
| major | Northshire Abbey, Eastvale Logging Camp |
...
## Geography
Northshire was the pride of Stormwind's vineyards until recently when Defias bandits drove off the farmers and occupied the farm and fields. In addition, the [Echo Ridge Mine](Echo Ridge Mine) north of the abbey has been infested by [kobolds](kobolds).

Kobolds infested the [Jasperlode Mine](Jasperlode Mine) and [Fargodeep Mine](Fargodeep Mine). [Gnolls](Gnolls) have erected camps in the [Forest's Edge](Forest's Edge) region and the northern rim of [Stone Cairn Lake](Stone Cairn Lake). It is rumored that both the kobolds and gnolls are somehow associated with the [Defias Brotherhood](Defias Brotherhood). [Murloc](Murloc)s have taken up residence in and around [Stone Cairn Lake](Stone Cairn Lake) and [Crystal Lake](Crystal Lake). Defias presence in the region has been growing and their people have holdings at [Mirror Lake Orchard](Mirror Lake Orchard), [Northshire Vineyards](Northshire Vineyards), the [Brackwell Pumpkin Patch](Brackwell Pumpkin Patch), [Jerod's Landing](Jerod's Landing) and [Stone Cairn Lake](Stone Cairn Lake).
...
|-
| [Westfall](Westfall) ||  || 10-20 || Southwest || By west bridge, swimming west across the [Nazferiti river](Nazferiti river), or flight path from Stormwind.
|-
| [Redridge Mountains](Redridge Mountains) ||  || 15-25 || East || By foot or by flight path from Stormwind.
|-
| [Duskwood](Duskwood) ||  || 18-30 || South || By east bridge, swimming south across the [Nazferiti river](Nazferiti river), or flight path from Stormwind.
|-
| [Northwind](Northwind) ||  || 28-34 || North|| By foot through Stormwind City or by flight path from Stormwind.
|-
|}
