---
title: "Galen Trollbane"
url: "https://turtle-wow.fandom.com/wiki/Galen_Trollbane"
source_type: "community wiki (turtle-wow.fandom.com), not an official source"
revision: "2026-06-01T02:10:49Z"
fetched: "2026-09-10T07:38:50Z"
is_turtle_content: false
patch: null
categories: ["Arathi Highlands NPCs", "Arathi Highlands mobs", "Human characters", "Stromgarde (kingdom)"]
---
# Galen Trollbane
...
| image | Galen Trollbane.png |
| level | 44 |
| type | Elite |
| faction | Alliance |
| aggro | Alliance Horde |
| affiliation | Stromgarde, Stormwind |
| race | Human |
| titles | Crown Prince of Stromgarde |
| creature | Humanoid |
| gender | Male |
...
A Horde jungle troll named [Zengu](Zengu) sought the sword [Trol'kalar](Trol'kalar), known as a legendary bane of trolls and heirloom of the Trollbane family, so that the Darkspear tribe could use it against the trolls of Zul'Gurub. The sword had been sealed in Thoras Trollbane's tomb since his death and opening the tomb required several sigils that were guarded by Stromgarde's fiercest warriors. The last of these sigils was guarded by Galen Trollbane himself.

[Lord Falconcrest](Lord Falconcrest) also seeks the prince's death to secure Stromgarde for the Syndicate.

## Objective of
- Drops [Sigil of Trollbane](Sigil of Trollbane) for [quest: Sigil of Trollbane].
- Must be killed for [quest: Securing the Keep].
