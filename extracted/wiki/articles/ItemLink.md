---
title: "ItemLink"
url: "https://turtle-wow.fandom.com/wiki/ItemLink"
source_type: "community wiki (turtle-wow.fandom.com), not an official source"
revision: "2026-02-23T14:32:42Z"
...
You can extract these identifiers from a given **itemString** with the following LUA-code:
 local found, _, itemId, enchantId, suffixId, uniqueId = string.find(**itemString**, "^item:(%d+):(%d+):(%d+):(%d+)")
...
- Full list of [EnchantIds](EnchantId).
- Full list of [SuffixIds](SuffixId).
...
## Example Item Strings
  ...
  -<code>"item:4388:0:0:210677200"</code>**
