---
title: "Patch 1.16.1"
url: "https://turtle-wow.fandom.com/wiki/Patch_1.16.1"
source_type: "community wiki (turtle-wow.fandom.com), not an official source"
revision: "2026-06-03T05:28:33Z"
...
- [Transmog Coins](Fashion Coin) can now drop from the endgame dungeon's last bosses, with more dropping from UBRS and custom dungeons.
...
- Hateforge Quarry Zone Music and Ambience
- Scarlet Citadel Main Theme
- Scarlet Citadel Zone Music and Ambience
- Crescent Grove Zone Music and Ambience
...
#### New Recipes | [Blacksmithing](Blacksmithing)
- [Plans: Hateforge Cuirass](Plans: Hateforge Cuirass)
- [Plans: Hateforge Helmet](Plans: Hateforge Helmet)
- [Plans: Hateforge Leggings](Plans: Hateforge Leggings)
- [Plans: Hateforge Belt](Plans: Hateforge Belt)
- [Plans: Hateforge Grips](Plans: Hateforge Grips)
- [Plans: Hateforge Boots](Plans: Hateforge Boots)
- [Plans: Bloodletter Razor](Plans: Bloodletter Razor)
- [Plans: Pauldron of Deflection](Plans: Pauldron of Deflection)
- [Plans: Dream's Herald](Plans: Dream's Herald)
- [Plans: Frostbound Slasher](Plans: Frostbound Slasher)

#### New Recipes | [Leatherworking](Leatherworking)
- [Pattern: Red Dragonscale Boots](Pattern: Red Dragonscale Boots)
- [Pattern: Red Dragonscale Shoulders](Pattern: Red Dragonscale Shoulders)
- [Pattern: Red Dragonscale Leggings](Pattern: Red Dragonscale Leggings)
- [Pattern: Shadowskin Boots](Pattern: Shadowskin Boots)
- [Pattern: Dragonscale Leggings](Pattern: Dragonscale Leggings)
- [Pattern: Stormscale Leggings](Pattern: Stormscale Leggings)
- [Pattern: Verdant Dreamer's Breastplate](Pattern: Verdant Dreamer's Breastplate)

#### New Recipes | [Tailoring](Tailoring)
- [Pattern: Robe of Sacrifice](Pattern: Robe of Sacrifice)

#### Raid Item Adjustments | [Molten Core](Molten Core)
- Increased the proc chance of [Shadowstrike](Shadowstrike) and [Thunderstrike](Thunderstrike) from 1 proc per minute to 1.5 procs per minute.
- Increased Health Regen of [Sash of Whispered Secrets](Sash of Whispered Secrets) from 6 to 10 every 5 seconds.
- Removed 11 Spirit from [Seal of the Archmagus](Seal of the Archmagus) and added 13 Spellpower instead.
- Removed 10 Spirit from [Band of Sulfuras](Band of Sulfuras) and added 12 Spellpower instead.
- Added 69 Holy Spellpower to [Benediction](Benediction).

#### Raid Item Adjustments | [Onyxia's Lair](Onyxia's Lair)
- Removed Spirit from [Dragonslayer's Signet](Dragonslayer's Signet), reduced Intellect and Stamina from 12 to 8, and added 18 Spellpower.
- Reduced all resistances of [Ring of Binding](Ring of Binding) from 10 to 5, Increased Defense from 4 to 6, Increased Armor from 60 to 100, and added 16 Stamina.

#### Raid Item Adjustments | [Blackwing Lair](Blackwing Lair)
- Increased the fire delay of [Dragonbreath Hand Cannon](Dragonbreath Hand Cannon) from 2.6 seconds to 3.1 seconds, the damage values have been increased accordingly to keep the DPS the same.
- Added 5% Mana regeneration in combat to [Gloves of Rapid Evolution](Gloves of Rapid Evolution).
- Removed 17 Spirit from [Black Ash Robe](Black Ash Robe) and added 20 Spellpower instead.
- Replaced 17 Spirit of [Herald of Woe](Herald of Woe) with Agility.
- Replaced 15 Spirit of [Primalist's Linked Waistguard](Primalist's Linked Waistguard) with 15 Agility, also added 1% Haste.
- Removed spirit from [Girdle of the Fallen Crusader](Girdle of the Fallen Crusader), increased Agility from 10 to 16 and Stamina from 15 to 17. Also added 1% haste.
- Removed spirit from [Primalist's Linked Legguards](Primalist's Linked Legguards) and added 13 Spellpower instead, also increased Stamina and Intellect from 22 to 23.
- Removed spirit from [Angelista's Grasp](Angelista's Grasp) and added 11 Spellpower instead.
- Removed spirit from [Therazane's Link](Therazane's Link) and increased Intellect from 12 to 14, increased Stamina from 22 to 24 and added 1% Haste.

#### Raid Item Adjustments | [Temple of Ahn'Qiraj](Temple of Ahn'Qiraj)
- Added two new items to Ouro's loot table: [Wormhide Boots](https://database.turtle-wow.org/?item=21613) | [Wormscale Stompers](https://database.turtle-wow.org/?item=21612)
- All drop chances will stay equal.
- Reduced stamina of [Gloves of the Redeemed Prophecy](Gloves of the Redeemed Prophecy) from 20 to 16 and Intellect from 20 to 10, added 12 Agility and replaced 37 Healing Power with 20 Spellpower
- Reduced intellect of [Gloves of the Fallen Prophet](Gloves of the Fallen Prophet) from 20 to 15, replaced 44 Healing Power with 23 Spellpower. Gloves of the Fallen Prophet will be added to the same trash loot tables as the Gloves of the Redeemed Prophecy as the shaman counterpart of their Prophecy set.
- Increased spell power of [Scaled Leggings of Qiraji Fury](Scaled Leggings of Qiraji Fury) from 36 to 39.
- Replaced 10 Spirit of [Gauntlets of the Righteous Champion](Gauntlets of the Righteous Champion) with Agility.
- Replaced 10 Spirit of [Gauntlets of Kalimdor](Gauntlets of Kalimdor) with Agility.
- Replaced 1% Parry on [Thick Qirajihide Belt](Thick Qirajihide Belt) with 1% Dodge, Increased Strength from 10 to 13 and Agility from 15 to 18.
- Increased the fire delay of [Blessed Qiraji Musket](Blessed Qiraji Musket) from 2.6 seconds to 3.1 seconds, the damage values have been increased accordingly to keep the DPS the same.
- Swapped around the stats of **Mantle of the Desert Crusade** and renamed to [Mantle of the Redeemed Prophecy](Mantle of the Redeemed Prophecy): Intellect: 20 to 6 | Stamina: 17 to 20 | Strength: 10 to 17 | Agility: 6 to 10 | Swapped 44 Healing Power for 23 | Spellpower and 21 Healing Power
- Reduced intellect of **Mantle of the Desert's Fury** from 20 to 15, Increased Strength from 6 to 9, and added 9 Agility. Renamed to [Mantle of the Fallen Prophet](Mantle of the Fallen Prophet) and got a new model.

#### Raid Item Adjustments | [Naxxramas](Naxxramas)
- [Digested Hand of Power](Digested Hand of Power): Reduced Intellect from 14 to 8, Reduced Stamina from 10 to 6, Increased MP5 from 10 to 12.
- [Pendant of Forgotten Names](Pendant of Forgotten Names): Reduced Intellect and Spirit from 16 to 13, Increased MP5 from 7 to 10.
- In addition to these changes all but the Tier 3 paladin tier sets are getting a major glow up.

#### Raid Item Adjustments | [Zul'Gurub](Zul'Gurub) Set ([Zandalar Freethinker](Zandalar Freethinker))
...
- [Zandalar Freethinker's Bindings](Zandalar Freethinker's Bindings): Replaced 11 Healing Power with 6 Spellpower and 6 Healing Power.
- [Zandalar Freethinker's Belt](Zandalar Freethinker's Belt): Replaced 26 Healing Power with 12 Spellpower and 14 Healing Power.
- Added [Zandalar Signet of Tenacity](Zandalar Signet of Tenacity) that applies 14 Stamina to your shoulders, bought for 15 tokens at exalted with Zandalar Tribe.

#### Raid Item Adjustments | [Ruins of Ahn'Qiraj](Ruins of Ahn'Qiraj) Set ([Battlegear of Eternal Justice](Battlegear of Eternal Justice))
...
- [Cape of Eternal Justice](Cape of Eternal Justice): Replaced 5 Mana Regen with 14 Spellpower.

#### Raid Item Adjustments | Tier 1 ([Lawbringer](Lawbringer))
- Replaced spirit with agility on all tier pieces.
- [Lawbringer Belt](Lawbringer Belt), [Boots](Lawbringer Boots), [Gauntlets](Lawbringer Gauntlets), and [Spaulders](Lawbringer Spaulders): Replaced 18 Healing Power with 11 Spellpower and 7 Healing Power.
- [Lawbringer Chestguard](Lawbringer Chestguard), [Helm](Lawbringer Helm), and [Legplates](Lawbringer Legplates): Replaced 22 Healing Power with 13 Spellpower and 8 Healing Power.

#### Raid Item Adjustments | Tier 2 ([Judgement](Judgement))
- Replaced spirit with agility on all tier pieces.
...
- [Judgement Breastplate](Judgement Breastplate): Removed 10 Fire Resistance and increased Agility from 5 to 11.
- [Judgement Crown](Judgement Crown): Removed 10 Frost Resistance and increased Agility from 6 to 12.
- [Judgement Legplates](Judgement Legplates): Removed 10 Arcane Resistance and increased Agility from 5 to 11.

#### Raid Item Adjustments | [Temple of Ahn'Qiraj](Temple of Ahn'Qiraj) Set (Tier 2.5) (Avenger)
- Removed spirit and redistributed the stats on agility and stamina.
- [Avenger's Pauldrons](Avenger's Pauldrons): Increased Agility from 14 to 15 and Stamina from 15 to 16
- [Avenger's Greaves](Avenger's Greaves): Increased Agility from 13 to 14 and Stamina from 18 to 19
- [Avenger's Crown](Avenger's Crown): Increased Agility from 12 to 16 and Stamina from 22 to 23
- [Avenger's Legguards](Avenger's Legguards): Increased Agility from 12 to 17 and Stamina from 22 to 23
- [Avenger's Breastplate](Avenger's Breastplate): Increased Agility from 12 to 17, Stamina from 24 to 25 and replaced 1% Spell Crit with 1% Physical Hit.

#### New Item Set | [Red Dragon Mail](Red Dragon Mail) (4)
...
#### New Item Set | [Incendosaur Skin Armor](Incendosaur Skin Armor) (3)
- (2) Set: Adds 2 fire damage to your melee atacks
- (3) Set: 5% chance of dealing 15 to 26 Fire damage on a successful melee attack

#### New Item Set | [Hateforge Armor](Hateforge Armor) (6)
- (2) Set: +20 Attack Power
- (4) Set: +100 Armor Penetration
- (6) Set: +2% Haste

#### New Item Set | [Living Armor](Living Armor) (3)
- (2) Set: +24 Healing Power
- (3) Set: Allows 10% of your Mana regeneration to continue while casting

#### New Item Set | [Bloody Gladiator's Regalia](Bloody Gladiator's Regalia) (8)
Full cloth armor set accessible with Blood Ring reputation.
- (2) Set: +20 Stamina
- (4) Set: +20 Spell Penetration
- (6) Set: +23 Spellpower
- (8) Set: +2% Spell Critical Chance

#### New Item Set | [Bloody Gladiator's Vestments](Bloody Gladiator's Vestments) (8)
Full leather armor set accessible with Blood Ring reputation.
- (2) Set: +20 Stamina
- (4) Set: +100 Armor Penetration
- (6) Set: +40 Attack Power
- (8) Set: +2% Physical Critical Chance

#### New Item Set | [Bloody Gladiator's Pursuit](Bloody Gladiator's Pursuit) (8)
Full mail armor set accessible with Blood Ring reputation.
- (2) Set: +20 Stamina.
- (4) Set: %2 Haste and +10 Spell Penetration
- (6) Set: +20 Attack Power and +13 Spellpower
- (8) Set: +1% Physical and Spell Critical Chance

#### New Item Set | [Bloody Gladiator's Battlegear](Bloody Gladiator's Battlegear) (8)
Full plate armor set accessible with Blood Ring reputation.
- (2) Set: +20 Stamina.
- (4) Set: +100 Armor Penetration
- (6) Set: +40 Attack Power
- (8) Set: +2% Physical Critical Chance

#### New Item Set | [Warbear Armor](Warbear Armor) (2)
- (2) Set: +1% Physical Critical and Dodge Chance

#### New Item Set | [Dragon Mail](Dragon Mail) (3)
- (2) Set: +10 Stamina
- (3) Set: +100 Armor Penetration

#### New Item Set | [Redemption of the Prophecy](Redemption of the Prophecy) and [Fall of the Prophet](Fall of the Prophet) (2)
- (2) Set: +14 Spellpower
...
### [Abyssal Council](Abyssal Council) | High Council Bosses Changes
...
- [Elemental Focus Band](Elemental Focus Band): Increased spell power from 22 to 24
- [Earthern Guard](Earthern Guard): Armor buffed from 2468 to 2575, Block buffed from 44 to 47, added 1% Block chance.
- [Windshear Cape](Windshear Cape): Increased Strength from 8 to 10, added 1% Haste.
...
- [Skaldrenox's Rage](Skaldrenox's Rage): A flaming polearm that has a chance to blast your opponent for 205 to 245 Fire damage. 64.6 DPS
- [Tempest's Rage](Tempest's Rage): A stormy one-handed sword that has a chance to increase your attack speed by 15% for 20 seconds. 49.7 DPS
- [Pearl of the Tides](Pearl of the Tides): A misty trinket that increases spell power by 32 and mana regen by 6 every 5 seconds.
- [Blackstone Crown](Blackstone Crown): A stone-hewn mail helmet with 473 Armor, 10 Strength, 15 Agility, 34 Stamina and 1% Dodge chance.

### PvP Changes
- [Sunnyglade Valley](Sunnyglade Valley) now gives 400 Honor on the win and 120 Honor on defeat to make it more worthwhile for those that are working on rankings.
- [Blood Ring](Blood Ring) will now give 25% of the winners' reputation and honor upon a loss.
...
### Misc Changes
- A lot of restrictions on [Transmogrification](Transmogrification) have been lifted. A more in depth explanation on what is and what isn't possible now will come.
...
###### Discipline
New Talent: **[Reflective Shields](Reflective Shields)** (Row 5)
...
[Orc](Orc): **[Feral Spirit](Feral Spirit)** | 21% Base Mana Cost | 5 Minute Cooldown

Summons two Spirit Wolves under the command of the Shaman for 20 seconds.

[Tauren](Tauren): **[Spirit Link](Spirit Link)** | 21% Base Mana Cost |10 Minute Cooldown
...
[Troll](Troll): **[Hex](Hex)** | 21% Base Mana Cost | 5 Minute Cooldown
...
##### Changes to Baseline Spells
New Rank 2 of **[Stormstrike](Stormstrike)** added, learnable at level 60. Differences from Rank 1: Cooldown is 12 seconds as opposed to the 20 seconds of Rank 1. Costs 12% of your base Mana as opposed to 21% of your base Mana with Rank 1.
...
New Talent: **[Spirit Armor](Spirit Armor)** (Row 4)
...
##### Changes to Baseline Spells
[Voidwalker](Voidwalker)'s [Torment](Torment) now deals a very small amount of Shadow damage. Damage is increased by the [Improved Voidwalker](Improved Voidwalker) talent.
...
##### New Abilities
New Ability: **[Mana Funnel](Mana Funnel)**
...
New Ability: **[Demon Portal](Demon Portal)** | Learned via hidden Grimoire at Level 60 | 30 Minute Cooldown
...
[Avoidance](Avoidance) | Learned from Demon Trainers at Level 40
...
##### New Abilities
New Ability: **[Intervene](Intervene)** | 10 Rage | 30 Second Cooldown | Requires Defensive Stance | Acquired via Book at Level 50
...
New Ability: **[Decisive Strike](Decisive Strike)** | 15 Rage | 2 Second Cast
...
New Passive: **[Die by the Sword](Die by the Sword)** | Acquired via Book at Level 58
