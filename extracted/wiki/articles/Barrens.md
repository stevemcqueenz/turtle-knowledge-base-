---
title: "Barrens"
url: "https://turtle-wow.fandom.com/wiki/Barrens"
source_type: "community wiki (turtle-wow.fandom.com), not an official source"
revision: "2026-05-17T16:47:33Z"
fetched: "2026-09-10T07:38:23Z"
is_turtle_content: true
patch: "1.16.4"
categories: ["Barrens", "Grasslands", "Kalimdor", "Turtle WoW content"]
---
# Barrens
...
| faction | Neutral |
| level | 7 - 30 |
| races | Orc, Tauren, Goblin, Quilboar, Centaur, Jungle troll, Dwarf, Human, Night elf, Forsaken, Harpy, Murloc |
| rulers | Thork, Jorn Skyseer, Captain Fairmount, Gazlowe |
| major | The Crossroads, Northwatch Hold, Bael Modan, Ratchet, Razorfen Kraul, Razorfen Downs |
| minor | Camp Taurajo, Mor'shan Rampart, Honor's Stand, Anchor's Edge |
| affiliation | Horde, Alliance, Steamwheedle Cartel, Burning Blade clan, Venture Company, Razormane tribe, Razorfen tribe, Witchwing |
| loc | Eastern Central Kalimdor |
| territory | Contested |

The **Barrens** is a large [zone](zone) in [central Kalimdor](central Kalimdor) controlled mostly by the [Horde](Horde). It is a massive savanna, with a few oases in the north-central region around the [Crossroads](Crossroads). Before the upheaval, several large [kaldorei](kaldorei) cities stood here. Now, those brave few willing to scrape out a life on the arid plains inevitably run afoul of [centaur](centaur) warbands or [quilboar](quilboar) raiding parties. Despite its often uninviting terrain and hostile inhabitants, the Barrens receive a good deal of interest from [Alliance](Alliance) and [Horde](Horde) alike, as well as races native to Kalimdor. Trade routes crisscross the landscape leading to and from more inviting regions, and the most notable route is the [Gold Road](Gold Road) that runs north-to-south through the Barrens and beyond. Rumours suggest that precious minerals and treasure-filled ruins await those with the courage to investigate.

## Geography
The Barrens are huge, one of the largest zones in the game. The land is mostly flat, with a few hills scattered throughout. The climate is harsh and hot, but survivable due to several lush oasis. With a stretch of [coastline](The Merchant Coast) to the east, [mountains](Stonetalon Mountains) to the northwest, [plains](Mulgore) to the west, [forest](Ashenvale) to the north, [marsh](Dustwallow Marsh) to the southeast, and the desert conditions to the [south](Thousand Needles) and [northeast](Durotar), the Barrens is surrounded by extremely varied landscapes.

The Barrens contain three instanced dungeons, the [Wailing Caverns](Wailing Caverns), [Razorfen Kraul](Razorfen Kraul), and [Razorfen Downs](Razorfen Downs). The Horde entrance to [Warsong Gulch](Warsong Gulch) is located to the north. There are two Horde aligned travel hubs in this zone: [the Crossroads](the Crossroads) and [Camp Taurajo](Camp Taurajo), in addition to the flight path and boat in [Ratchet](Ratchet) available to both factions. There are no raid dungeons in the Barrens.

### Screenshots
<gallery>
File:Mor'shan Rampart.jpg|thumb|300px|The Mor'shan Rampart.
File:Crossroads.jpg|thumb|300px|The Crossroads
File:Barrens at Day.jpg|thumb|300px|The Barrens at Day
File:Barrens at Night.jpg|thumb|300px|The Barrens at Night
</gallery>

### Maps and subregions
<gallery>
WorldMap-Barrens-old2.jpg|Map of the Barrens prior to patch 1.16.4
WorldMap-Barrens-old.jpg|Map of the Barrens prior to patch 1.5.0.
</gallery>
...
|-
| [Durotar](Durotar) ||  || 1-12
| Northeast
| By foot across the river or by flightpath from [Crossroads](Crossroads) to [Orgrimmar](Orgrimmar).
|-
| [Mulgore](Mulgore) ||  || 1-12
| West
| By foot or flightpath from [Crossroads](Crossroads) or [Camp Taurajo](Camp Taurajo) to [Thunder Bluff](Thunder Bluff).
|-
| [Stonetalon Mountains](Stonetalon Mountains)
| 
| 15-27 || Northwest
| By foot or flightpath from [Crossroads](Crossroads) to [Sun Rock Retreat](Sun Rock Retreat).
|-
| [Ashenvale](Ashenvale)
| 
| 18-30 || North
| By foot or flightpath from [Crossroads](Crossroads) to [Splintertree Post](Splintertree Post) or [Zoram'gar Outpost](Zoram'gar Outpost).
|-
| [Thousand Needles](Thousand Needles)
| 
| 25-35 || South
| By elevator or flightpath from [Crossroads](Crossroads) or [Camp Taurajo](Camp Taurajo) to [Freewind Post](Freewind Post).
|-
| [Stranglethorn Vale](Stranglethorn Vale)
| 
| 32-45 || East across the sea || By boat from [Ratchet](Ratchet) to [Booty Bay](Booty Bay).
|-
| [Dustwallow Marsh](Dustwallow Marsh)
| 
| 35-45 || Southeast || By foot or flightpath from [Crossroads](Crossroads) or Ratchet to [Brackenwall Village](Brackenwall Village).
|}
...
- Leather
  ...
  - [Thin Kodo Leather](Thin Kodo Leather)
  - [Deviate Scale](Deviate Scale)
  - [Perfect Deviate Scale](Perfect Deviate Scale)
- Ore
  - [Copper Vein](Copper Vein)
  - [Tin Vein](Tin Vein)
  - [Silver Vein](Silver Vein)
- Fish
  - [Deviate Fish](Deviate Fish)
- Lumber
