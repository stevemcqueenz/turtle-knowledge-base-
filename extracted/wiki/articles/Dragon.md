---
title: "Dragon"
url: "https://turtle-wow.fandom.com/wiki/Dragon"
source_type: "community wiki (turtle-wow.fandom.com), not an official source"
revision: "2025-12-08T20:46:28Z"
fetched: "2026-09-10T07:38:39Z"
is_turtle_content: false
patch: null
categories: ["Creatures", "Dragon", "Dragonkin", "Game Terms", "Intelligent Creatures", "Lore", "Pages with broken file links"]
---
# Dragon
...
# The [Dragon Aspects](Dragon Aspects)
The [Titan](Titan)s chose a member of each of the 5 dragonflights to watch over Azeroth in their absence:
- [Nozdormu](Nozdormu)
...
# The Dragonflights
See [Dragonflights](Dragonflights).

# Pets
## Whelpling Pets
Some very small dragons can be obtained as ["vanity pets"](:Category:Small Pets):
- [Dark Whelpling](Dark Whelpling)
- [Tiny Crimson Whelpling](Tiny Crimson Whelpling) 
- [Tiny Emerald Whelpling](Tiny Emerald Whelpling)

## Mechanical Dragonling Pets
The Gnomes have long been studying dragons and their unique properties.  Many Gnomes believe that if they can harness the power of the dragon, they could easily retake the city of [Gnomeregan](Gnomeregan).  While they are a long way away from constructing a mechanical dragon the equal of the Dragonflights, they have devised plans for a number of [Mechanical Dragonling](Mechanical Dragonling)s.  These combat pets can be used in battle.
