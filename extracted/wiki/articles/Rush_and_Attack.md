---
title: "Rush and Attack"
url: "https://turtle-wow.fandom.com/wiki/Rush_and_Attack"
source_type: "community wiki (turtle-wow.fandom.com), not an official source"
revision: "2025-10-17T07:53:03Z"
...
<nowiki>https://discord.gg/8ZDdPhAu6C</nowiki>

Joining Rush and Attack is possible only through the submission of a questionnaire in the guild discord.

## **Guild rules**
[1.1] Swearing is allowed in a context that is not offensive to other participants, without abuse and fanaticism.

[1.2] Messages in distorted language, excessive use of slang, jargon, AUE expressions are prohibited.

[1.3] It is forbidden to write meaningless or low-content information that does not carry a semantic load (flood / spam).

[1.4] The publication of materials of a rude, violent nature, cruelty, calls for such, messages of an extremist nature and begging is prohibited.

[1.5] It is forbidden to insult other users of the server, whether directly or indirectly.  An insult remains a violation, even if it is hidden under sarcasm (excessive irony) or indirect insinuation.  It is forbidden to use offensive and rude forms in the profile - in nicknames / avatars, especially if this is somehow intended to offend other server members.

[1.6] It is forbidden to post slanderous and reputation-damaging messages to members and guilds of the server, both your own and others.

[1.7] Any kind of provocation and stuffing is prohibited (politics, orientation, etc.).

[1.8] Discrimination on any grounds — racial, national, civil, gender, religious, age, disability, occupation or sexual orientation, as well as the use of derogatory definitions of different nationalities is prohibited.

[1.9] Due to the possibility of unwanted PvP flags appearing, open world battles between guild players in such situations are only allowed outside of dungeon and raid groups and in case of mutual agreement of the participants.

[1.10] It is forbidden to disclose information related to the activities of the guild (as well as the actions that led to it), which can harm the gameplay of its individual members, or achieve the goals of the guild as a whole.

[1.11] We also urge all guild members to comply with the norms adopted in online communities, so as not to discredit the name of our small community.

## **PVE**
The guild includes two statics differing in composition and playing time. **Far Eastern Static** start raids at 15:00 Moscow time. **Moscow Static** start raids at 20:00 Moscow time.

The guild also holds regular "guest" raids to which everyone can join to get their share of experience and PVE progress.
