---
title: "Deadmines"
url: "https://turtle-wow.fandom.com/wiki/Deadmines"
source_type: "community wiki (turtle-wow.fandom.com), not an official source"
revision: "2025-12-27T04:25:09Z"
fetched: "2026-09-10T07:38:36Z"
is_turtle_content: true
patch: "1.17.2"
categories: ["Deadmines", "Dungeons", "Turtle WoW content", "Westfall subzones"]
---
# Deadmines
...
| name | The Deadmines |
| aka | VC, DM |
| ss | Deadmines loading screen.png |
| caption | Deadmines loading graphic |
| loc | Moonbrook, Westfall |
| race | Human, Goblin, Murloc, Ogre, Tauren |
| boss |  |
| level | 16-24 |
| players | 5 |
| bosses |  |
...
Prior to the First War, the Deadmines were the greatest gold production center in human lands. The mines also had an abundance of Whitestone oak lumber; it was used in the construction of some of the more important lattices and tools because of its resilience to heat and pressure. (ref: [Jordan's Weapon Notes](Jordan's Weapon Notes)) However, they were abandoned during the First War. During that time, Sir [Anduin Lothar](Anduin Lothar) ventured into the perilous Deadmines on a quest to obtain the Tome of Divinity, but was captured by a band of ogres and held captive for twenty months. He was ultimately rescued and successful in his mission. It was also to the dungeons below the Deadmines that [Blackhand](Blackhand)'s daughter [Griselda](Griselda) fled with the ogre [Turok](Turok). Both were slain by an orcish raid. Many slimes inhabited the dungeons at that time, but they have not been encountered lately.

For a time, the [Miners' League](Miners' League) was partly in charge of the Deadmines under the direction of [Foreman Thistlenettle](Foreman Thistlenettle) and [Wilder Thistlenettle](Wilder Thistlenettle). However, one day the Defias Brotherhood attacked them during their work and the mine tunnel collapsed. Only Wilder managed to escape, while the rest of the company died and began to roam as restless undead. In Stormwind City, Wilder sent adventurers to find his brother, or at least his badge to give him some peace of mind. (ref: [quest: Oh Brother. . .]) He also asked them to find their union cards, in order to make sure their families get some resolution from this tragedy. (ref: [quest: Collecting Memories])

## Geography
### Maps and subregions
<gallery>
File:WorldMap-DeadminesEntrance.jpg|Exterior
File:WorldMap-Deadmines.jpg|Interior
</gallery>

{| class="fandom-table"
|-
|[Goblin Foundry](Goblin Foundry) • [Harvest Golem Foundry](Harvest Golem Foundry) • [Ironclad Cove](Ironclad Cove) • [Mast Room](Mast Room) • [Zanzil Laboratory](Zanzil Laboratory)
|}
...
| [Sentinel Hill](Sentinel Hill), [Westfall](Westfall)
|-
| [quest: The Harvest Golem Mystery]
| 
| [Gartside Plot](Gartside Plot), [Westfall](Westfall)
|-
| [quest: Turning Off The Tap]
| 
| [Old Town](Old Town), [Stormwind City](Stormwind City)
|-
| [quest: The Unsent Letter]
| [An Unsent Letter](An Unsent Letter), dropped by

| [Ironclad Cove](Ironclad Cove), **Deadmines**
|-
! colspan="3" | Horde quests
|- class="alt"
| [quest: Prototype Thievery]
| 
| [Sparkwater Port](Sparkwater Port), [Durotar](Durotar)
|-
! colspan="3" | Neutral quests
|- class="alt"
| [quest: Captain Grayson's Revenge]
| 
| [Westfall Lighthouse](Westfall Lighthouse), [Westfall](Westfall)
|-
|}
