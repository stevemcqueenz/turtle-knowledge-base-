---
title: "Durotar"
url: "https://turtle-wow.fandom.com/wiki/Durotar"
source_type: "community wiki (turtle-wow.fandom.com), not an official source"
revision: "2026-03-29T17:22:25Z"
fetched: "2026-09-10T07:38:42Z"
is_turtle_content: true
patch: "1.16.0"
categories: ["Durotar", "Kalimdor", "Starting areas", "Turtle WoW content"]
---
# Durotar
...
| name | Durotar |
| ss | Durotar.jpg |
| affiliation | Nation of Durotar, Darkspear tribe, Horde, Kingdom of Kul Tiras, Alliance, Razormane tribe, Burning Blade |
| capital | Orgrimmar |
| races | Orc, Jungle troll, Tauren, Forsaken, Human, Quilboar, Centaur, Harpy, Goblin |
| level | 1 - 10 |
| loc | Northeastern Central Kalimdor |
| ruler | Thrall, Vol'jin |
...
### Maps and subregions
<gallery>
WorldMap-Durotar-old.jpg|Map of Durotar prior to [patch 1.16.0](patch 1.16.0).
</gallery>

{| class="fandom-table"
|-
|[Bladefist Bay](Bladefist Bay) ([Skull Rock](Skull Rock)) • [Darkspear Strand](Darkspear Strand) ([Sen'jin Village](Sen'jin Village)) • [Deadeye Shore](Deadeye Shore) • [Echo Isles](Echo Isles) • [Great Sea](Great Sea) • [Hidden Path](Hidden Path) • [Jaggedswine Farm](Jaggedswine Farm) • [Kolkar Crag](Kolkar Crag) • [Razor Hill](Razor Hill) ([Razor Hill Barracks](Razor Hill Barracks)) • [Razormane Grounds](Razormane Grounds) • [Razorwind Canyon](Razorwind Canyon) ([Drygulch Ravine](Drygulch Ravine) • [Dustwind Cave](Dustwind Cave)) •  [Orgrimmar](Orgrimmar) • [Rocktusk Farm](Rocktusk Farm) • [Scuttle Coast](Scuttle Coast) ([Tiragarde Keep](Tiragarde Keep)) • [Shrine of the Dormant Flame](Shrine of the Dormant Flame) • [Southfury River](Southfury River) • [Sparkwater Port](Sparkwater Port) • [Spirit Rock](Spirit Rock) • [Thunder Ridge](Thunder Ridge) • [Tor'kren Farm](Tor'kren Farm) • [Valley of Trials](Valley of Trials) ([Burning Blade Coven](Burning Blade Coven) • [The Den](Den))
|}

### Travel hubs
The Horde capital city, [Orgrimmar](Orgrimmar), is located in this zone, and is a major travel hub for Horde characters. In addition, the [Zeppelin](Zeppelin) towers near Orgrimmar can carry players to the [Eastern Kingdoms](Eastern Kingdoms), to either [Undercity](Undercity), [Kargath](Kargath) or [Grom'gol Base Camp](Grom'gol Base Camp). Boats traveling from [Sparkwater Port](Sparkwater Port) can carry players to [Revantusk Village](Revantusk Village), in the Eastern Kingdoms.

#### [Flight path](Flight path)s from [Orgrimmar](Orgrimmar)
...
#### [Zeppelin](Zeppelin) tower east of [Orgrimmar](Orgrimmar)
- [Grom'gol Base Camp](Grom'gol Base Camp), [Stranglethorn Vale](Stranglethorn Vale)
- [Tirisfal Glades](Tirisfal Glades)

#### [Zeppelin](Zeppelin) tower west of [Orgrimmar](Orgrimmar)
- [Thunder Bluff](Thunder Bluff)
- [Kargath](Kargath), [Badlands](Badlands)

#### Boat destinations from [Sparkwater Port](Sparkwater Port)
...
! Access
|-
| [Thunder Bluff](Thunder Bluff) ||  || N/A 
| Southwest || By zeppelin or by flight path from [Orgrimmar](Orgrimmar).
|-
| [Tirisfal Glades](Tirisfal Glades) ||  || 1-10 
| Northeast across the ocean || By zeppelin to a tower near [Brill](Brill).
|-
| [The Barrens](Barrens) ||  || 7-30
| West || By foot across the river, by flight paths from [Orgrimmar](Orgrimmar), or by swimming from [Darkspear Strand](Darkspear Strand) to [Ratchet](Ratchet).
|-
| [Ashenvale](Ashenvale) ||  || 18-30
| Northwest || Swim north along the river and head west, or by flight path from [Orgrimmar](Orgrimmar) to [Splintertree Post](Splintertree Post).
|-
| [Stranglethorn Vale](Stranglethorn Vale) ||  || 30-45
| Southeast across the ocean || By zeppelin to [Grom'gol Base Camp](Grom'gol Base Camp).
|-
| [Badlands](Badlands) ||  || 35-45
| Southeast across the ocean || By zeppelin to [Kargath](Kargath).
|-
| [Hinterlands](Hinterlands) ||  || 40-50
| Northeast across the ocean || By boat from [Sparkwater Port](Sparkwater Port) to [Revantusk Village](Revantusk Village).
|-
| [Azshara](Azshara) ||  || 45-55
| North || Swim along the river and head west and then cross a bridge, or by flight path from [Orgrimmar](Orgrimmar) to [Valormok](Valormok).
|}
