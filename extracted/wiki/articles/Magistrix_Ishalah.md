---
title: "Magistrix Ishalah"
url: "https://turtle-wow.fandom.com/wiki/Magistrix_Ishalah"
source_type: "community wiki (turtle-wow.fandom.com), not an official source"
revision: "2025-12-22T06:02:44Z"
fetched: "2026-09-10T07:39:12Z"
is_turtle_content: true
patch: "1.17.1"
categories: ["Alah'Thalas NPCs", "High elf characters", "Removed Loch Modan NPCs", "Thalassian Highlands NPCs", "Turtle WoW content"]
---
# Magistrix Ishalah
...
## Notes
- After the addition of the [Thalassian Highlands](Thalassian Highlands) to the game, Magistrix Ishalah was moved from the Farstrider Lodge to the new high elf starting area. However, she was also placed in the [Golden Dawn Institute](Golden Dawn Institute) in [Alah'Thalas](Alah'Thalas), taking the place of [Tanilaeh Sunkiss](Tanilaeh Sunkiss) who formerly teleported adventurers to [Stormwind City](Stormwind City).

## Patch changes
- (Patch 1.17.1|note=Moved from [Farstrider Lodge](Farstrider Lodge) in [Loch Modan](Loch Modan) to both the new high elf starting area at [Brinthilien](Brinthilien) in the [Thalassian Highlands](Thalassian Highlands) and the [Golden Dawn Institute](Golden Dawn Institute) in [Alah'Thalas](Alah'Thalas).)
