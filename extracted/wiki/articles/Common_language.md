...
url: "https://turtle-wow.fandom.com/wiki/Common_(language)"
source_type: "community wiki (turtle-wow.fandom.com), not an official source"
revision: "2025-12-27T04:20:40Z"
...
### Common Quality
The level of [item](Item) [quality](Quality) above , but below .

#### Additional notes
- The names of **Common** quality items will appear in white.
- [Equip](Equip)pable items of **Common** quality usually have no [attribute](Attribute) bonuses.
- [Equip](Equip)pable items at **Common** quality and below *cannot* be [disenchanted](Disenchant) by characters with the [Enchanting](Enchanting) [profession](Profession).
- Most [ingredient](Ingredient) items are of **Common** quality.
