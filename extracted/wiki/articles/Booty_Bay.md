---
title: "Booty Bay"
url: "https://turtle-wow.fandom.com/wiki/Booty_Bay"
source_type: "community wiki (turtle-wow.fandom.com), not an official source"
revision: "2025-12-27T02:24:37Z"
fetched: "2026-09-10T07:38:27Z"
is_turtle_content: false
patch: null
categories: ["Articles using deprecated loot", "Bays", "Blackwater Raiders", "Booty Bay", "Cities", "Factions", "Goblin territories", "Harbors", "Neutral quest hubs", "Neutral settlements", "Steamwheedle Cartel", "Stranglethorn Vale subzones"]
---
# Booty Bay
...
| type | Port town |
| leader |  |
| race | Goblin, Human, Troll, Orc, Gnome, Tauren |
| language | Goblin, Common, Troll, Orcish, Gnomish, Taur-ahe |
| affiliation | Blackwater Raiders, Steamwheedle Cartel |
| faffiliation | Kingdom of Stormwind |
| loc | Southern Stranglethorn Vale |
| facilities | Yes |
| inn | Yes |
| mailbox | Yes |
| stables | Yes |
...
### World of Warcraft
Following the [Third War](Third War), Booty Bay was still run by the [Blackwater Raiders](Blackwater Raiders) who are closely associated with the [Steamwheedle Cartel](Steamwheedle Cartel), the port offers facilities to any traveler passing through, regardless of their faction. As the ruler of this city, [Baron Revilgaz](Baron Revilgaz) hires all the help he can get against the pesky [Bloodsail Buccaneers](Bloodsail Buccaneers) and other threats to the city. He resides, together with the leader of the [Blackwater Raiders](Blackwater Raiders), [Fleet Master Seahorn](Fleet Master Seahorn), at the top of the inn of Booty Bay.

Outside of Booty Bay, on the island of [Janeiro's Point](Janeiro's Point), is a giant statue of an unknown [goblin](goblin) with outstretched arms.
...
An alternative to killing Bloodsail Buccaneers is to do the repeatable quest [Cartel Gold Donations](Cartel Gold Donations) from [Clemence the Counter](Clemence the Counter) in the [Old Port Authority](Old Port Authority), which gives 250 reputation with all Steamwheedle Cartel factions per 10 gold turn-in.
...
| colspan=8 |
| colspan=1 |2.5
| colspan=1 |7.5 Rep for Named NPCs
|-
| colspan=6 |
| colspan=2 |
| colspan=1 |2.5
...
| colspan=2 |
| colspan=1 |5
| colspan=1 |25 Rep for Named NPCs ; unnamed until honored only
|}
