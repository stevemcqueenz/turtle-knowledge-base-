...
url: "https://turtle-wow.fandom.com/wiki/Thousand_Needles"
source_type: "community wiki (turtle-wow.fandom.com), not an official source"
revision: "2026-05-12T05:56:53Z"
fetched: "2026-09-10T07:39:52Z"
is_turtle_content: true
patch: "1.18.1"
categories: ["Kalimdor", "Thousand Needles", "Turtle WoW content"]
---
# Thousand Needles
...
| ss | The Great Lift.jpg |
| races | Centaur, Tauren, Harpy, Gnome, Goblin, Kobold |
| level | 25 - 35 |
| loc | Northeastern Southern Kalimdor |
| rulers | Cliffwatcher Longhorn, Arnak Grimtotem, Grenka Bloodscreech |
| major | Mirage Raceway, Roguefeather Den, Freewind Post, Darkcloud Pinnacle, Windhorn Canyon |
...
### Travel hubs
There is only one flight path in Thousand Needles, and that is Horde-aligned [Freewind Post](Freewind Post). However, Alliance travelers can use the nearby [Thalanaar](Thalanaar) flight path to the west, and the flight path in neutral [Gadgetzan](Gadgetzan) to the south to navigate the zone.

#### [Flight path](Flight path)s from [Freewind Post](Freewind Post)
...
| [The Barrens](Barrens) || 
| 7-30 || North
| By elevator or Horde flightpaths from Freewind Post to Camp Taurajo or the Crossroads
|-
| [Feralas](Feralas)
|  
| 40-50 || West
| By foot or Horde flightpath from Freewind Post to Camp Mojache
|-
| [Tanaris](Tanaris)
|  
| 40-50 || Southeast
| By foot or Horde flightpath from Freewind Post to Gadgetzan
|}
...
## Notes
- Until an update on November 1st, 2019, players could not race on the Mirage Raceway. (ref: [Patch 1.12.1+ — Mirage Raceway](https://forum.turtle-wow.org/viewtopic.php?t=811))
- [Shimmering Flats](Shimmering Flats) mobs have an oddly high rate of dropping blue BoE (lvl 20-27) gear, though this rate seems to only go as high as .5%.
