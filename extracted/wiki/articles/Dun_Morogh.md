---
title: "Dun Morogh"
url: "https://turtle-wow.fandom.com/wiki/Dun_Morogh"
source_type: "community wiki (turtle-wow.fandom.com), not an official source"
revision: "2026-03-30T02:39:07Z"
fetched: "2026-09-10T07:38:42Z"
is_turtle_content: true
patch: "1.18.0"
categories: ["Dun Morogh", "Dwarf territories", "Eastern Kingdoms", "Gnome territories", "Mountain ranges", "Starting areas", "Turtle WoW content"]
---
# Dun Morogh
...
| faction | Alliance |
| level | 1 - 10 |
| capital | Ironforge, Gnomeregan Reclamation Facility |
| races | Dwarf, Gnome, Dark Iron dwarf, Human, Ice troll, Leper gnome, Trogg |
| rulers | Magni Bronzebeard, Gelbin Mekkatorque |
| loc | Northwestern Khaz Modan |
| major | Kharanos, Anvilmar, Shimmer Ridge |
...
### Maps and subregions
<gallery>
WorldMap-DunMorogh old2.jpg|Dun Morogh prior to [patch 1.18.1](patch 1.18.1).
WorldMap-DunMorogh-old.jpg|Dun Morogh prior to [patch 1.17.0](patch 1.17.0).
</gallery>
...
### Travel hubs
##### [Flight path](Flight path)s from [Ironforge](Ironforge)
- [Stormwind City](Stormwind City), [Elwynn Forest](Elwynn Forest)
- [Gnomeregan Reclamation Facility](Gnomeregan Reclamation Facility), Dun Morogh
- [Ironforge Airfields](Ironforge Airfields), Dun Morogh
...
- [Aerie Peak](Aerie Peak), [The Hinterlands](The Hinterlands)
- [Chillwind Point](Chillwind Point), [Western Plaguelands](Western Plaguelands)
- [Light's Hope Chapel](Light's Hope Chapel), [Eastern Plaguelands](Eastern Plaguelands)

##### [Flight path](Flight path)s from [Gnomeregan Reclamation Facility](Gnomeregan Reclamation Facility)
- [Ironforge](Ironforge), Dun Morogh

##### [Flight path](Flight path)s from [Ironforge Airfields](Ironforge Airfields)
- [Ironforge](Ironforge), Dun Morogh
...
|-
| [Loch Modan](Loch Modan) ||  || 10-25 || East || By foot through [North Gate Pass](North Gate Pass)/[South Gate Pass](South Gate Pass), or by flightpath from [Ironforge](Ironforge).
|-
| [Wetlands](Wetlands) ||  || 20-30 || North || By foot from [Ironforge Airfields](Ironforge Airfields) or by flightpath from [Ironforge](Ironforge) or [Ironforge Airfields](Ironforge Airfields).
|-
|}
...
## Patch changes
- (Patch 1.18.0|note=[Rugford's Mountain Rest](Rugford's Mountain Rest) added.)
