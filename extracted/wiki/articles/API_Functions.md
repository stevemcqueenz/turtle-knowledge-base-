---
title: "API Functions"
url: "https://turtle-wow.fandom.com/wiki/API_Functions"
source_type: "community wiki (turtle-wow.fandom.com), not an official source"
revision: "2026-03-10T11:35:07Z"
...
These functions are those which operate with the action buttons
 UI [ActionButtonDown](API ActionButtonDown)(id)   - Press the specified action button.
 UI [ActionButtonUp](API ActionButtonUp)(id)   - Release the specified action button.
 [ActionHasRange](API ActionHasRange)(slot)   - Determine if the specified action is a range restriction (1 if yes, nil if no)
 UI [BonusActionButtonDown](API BonusActionButtonDown) - Trigger the specified bonus(pet or minion) action button.
 UI [BonusActionButtonUp](API BonusActionButtonUp) - Release the specified bonus(pet or minion) action button.
 PROTECTED [CameraOrSelectOrMoveStart](API CameraOrSelectOrMoveStart)()   - Begin "Left click" in the 3D world. (1.10 - Protected)
 PROTECTED [CameraOrSelectOrMoveStop](API CameraOrSelectOrMoveStop)([stickyFlag])   - End "Left click" in the 3D world. (1.10 - Protected)
 [ChangeActionBarPage](API ChangeActionBarPage)()   - Changes the current action button set to CURRENT_ACTIONBAR_PAGE.
 [GetActionBarToggles](API GetActionBarToggles)()   - Return the toggles for each action bar.
 [GetActionCooldown](API GetActionCooldown)(slot)   - This returns the cooldown values of the specified action..
 [GetActionCount](API GetActionCount)(slot)   - Get the count (bandage/potion/etc) for an action, returns 0 if none or not applicable.
 [GetActionText](API GetActionText)(slot)   - Get the text label (macros, etc) for an action, returns nil if none.
 [GetActionTexture](API GetActionTexture)(slot)   - Gets the texture path for the specified action.
 [GetBonusBarOffset](API GetBonusBarOffset)()   - Determine which page of bonus actions to show.
 [HasAction](API HasAction)(slot)   - Returns 1 if the player has an action in the specified slot, nil otherwise.
 [IsActionInRange](API IsActionInRange)(slot)   - Test if an action is in range (1=yes, 0=no, nil=not applicable).
 [IsAttackAction](API IsAttackAction)(slot)   - Return 1 if an action is an 'attack' action (flashes during combat), nil otherwise.
 [IsAutoRepeatAction](API IsAutoRepeatAction)(slot)   - Return 1 if an action is auto-repeating, nil otherwise.
 [IsCurrentAction](API IsCurrentAction)(slot)   - Return 1 if an action is the one currently underway, nil otherwise.
 [IsUsableAction](API IsUsableAction)(slot)   - Return 1 if an action can be used at present, nil otherwise.
 [IsConsumableAction](API IsConsumableAction)(slot)   - Return 1 if an action is consumable (i.e. has a count), nil otherwise.
 [IsEquippedAction](API IsEquippedAction)(slot)   - Return 1 if an action is equipped (i.e. connected to an item that must be equipped), nil otherwise.
 [PetHasActionBar](API PetHasActionBar)()   - Determine if player has a pet with an action bar.
 [PickupAction](API PickupAction)(slot)   - Drags an action out of the specified quickbar slot and holds it on the cursor.
 [PickupPetAction](API PickupPetAction)(slot)   - Drags an action from the specified pet action bar slot into the cursor.
 [PlaceAction](API PlaceAction)(slot)   - Drops an action from the cursor into the specified quickbar slot.
 [SetActionBarToggles](API SetActionBarToggles)(show1,show2,show3,show4[, alwaysShow])   - Set show toggle for each action bar   - 'alwaysShow' added in 1.12
 PROTECTED [TurnOrActionStart](API TurnOrActionStart)()   - Begin "Right Click" in the 3D world. (1.10 - Protected)
 PROTECTED [TurnOrActionStop](API TurnOrActionStop)()   - End "Right Click" in the 3D world. (1.10 - Protected)
 [UseAction](API UseAction)(slot[, checkCursor[, onSelf]])   - This instructs the interface to use the action associated with the specified ID, optionally on the player (regardless of target).

## Activity Functions
This section is for functions which make the player do something
 [AcceptDuel](API AcceptDuel)()   - The player accepts the challenge to duel.
 [AttackTarget](API AttackTarget)()   - Attacks the targetted unit.
 [CancelDuel](API CancelDuel)()   - Refuse the invitation to fight a duel.
 [CancelLogout](API CancelLogout)()
 [CancelMeetingStoneRequest](API CancelMeetingStoneRequest)()   - Remove character from an instance's Meeting Stone queue
 [ClearTutorials](API ClearTutorials)()
 [ConfirmSummon](API ConfirmSummon)()
 FlagTutorial("tutotial")
 PROTECTED [ForceLogout](API ForceLogout)()
 ...
 [Logout](API Logout) - Logs the user out of the game.
 [Quit](API Quit) - Quits the application, NOT the LUA script.
 [RandomRoll](API RandomRoll)(low, high)   - Does a random roll between the two values.
 [SitOrStand](API SitOrStand)()   - The player sits or stands.
 [StartDuel](API StartDuel)("name")   - Challenge someone to a duel (by name)
 [StartDuelUnit](API StartDuelUnit)("[unit](API Type UnitId)")   - Challenge a unit to a duel.
 [TogglePVP](API TogglePVP)()   - Toggles PVP Status
 [ToggleSheath](API ToggleSheath)()   - Toggles sheathed or unsheathed weapons.
 [UseSoulstone](API UseSoulstone)()   - Use an active soulstone to resurrect yourself after death.

## AddOn Functions
 [DisableAddOn](API DisableAddOn)(index or "AddOnName")   - Disable the specified AddOn for subsequent sessions.
 [DisableAllAddOns](API DisableAllAddOns)()   - Disable all AddOns for subsequent sessions.
 [EnableAddOn](API EnableAddOn)(index or "AddOnName")   - Enable the specified AddOn for subsequent sessions.
 [EnableAllAddOns](API EnableAllAddOns)()   - Enable all AddOns for subsequent sessions.
 [GetAddOnDependencies](API GetAddOnDependencies)(index or "AddOnName")   - Get dependency list for an AddOn.
 [GetAddOnInfo](API GetAddOnInfo)(index or "AddOnName")   - Get information about an AddOn.
 [GetAddOnMetadata](API GetAddOnMetadata)(index or "name", "variable")   - Retrieve metadata from addon's TOC file.
 [GetNumAddOns](API GetNumAddOns)()   - Get the number of user supplied AddOns.
 [IsAddOnLoaded](API IsAddOnLoaded)(index or "AddOnName")   - Returns true if the specified AddOn is loaded.
 [IsAddOnLoadOnDemand](API IsAddOnLoadOnDemand)(index or "AddOnName")   - Test whether an AddOn is load-on-demand.
 [LoadAddOn](API LoadAddOn)(index or "AddOnName")   - Request loading of a Load-On-Demand AddOn.
 [ResetDisabledAddOns](API ResetDisabledAddOns)() -

## Auction Functions
 [CalculateAuctionDeposit](API CalculateAuctionDeposit)(runTime)   - Returns the required deposit for the current selling item given the specified duration (minutes).
 [CanSendAuctionQuery](API CanSendAuctionQuery)()   - Return 1 if auction search button would be active, nil otherwise.
 [CancelAuction](API CancelAuction)(index)   - Cancel the specified auction (on the "owner" list).
 [ClickAuctionSellItemButton](API ClickAuctionSellItemButton)()   - Puts the currently 'picked up' item into the 'create auction' slot.
 [CloseAuctionHouse](API CloseAuctionHouse)()   - Will close the AuctionFrame if opened.
 [GetAuctionHouseDepositRate](API GetAuctionHouseDepositRate)()   - Returns the deposit rate (percentage) for the currently open auction house (Possibly out-dated by [CalculateAuctionDeposit](API CalculateAuctionDeposit)).
 [GetAuctionInvTypes](API GetAuctionInvTypes)(classIndex, subclassIndex)   - Returns types of subcategories items.
 [GetAuctionItemClasses](API GetAuctionItemClasses)()   - Returns major auction item categories.
 [GetAuctionItemInfo](API GetAuctionItemInfo)("type", index)   - Returns details about the specified auction item.
 [GetAuctionItemLink](API GetAuctionItemLink)("type", index)   - Returns an [itemLink](API Type ItemLink) for the specified auction item.
 [GetAuctionItemSubClasses](API GetAuctionItemSubClasses)(classIndex)   - Returns subcategories in the nth auction category.
 [GetAuctionItemTimeLeft](API GetAuctionItemTimeLeft)("type", index)   - Returns the time left status of the specified auction item.
 [GetAuctionSellItemInfo](API GetAuctionSellItemInfo)()   - Returns information about the current selling item (or nil if none selected).
 [GetBidderAuctionItems](API GetBidderAuctionItems)([page])   - ?.
 [GetNumAuctionItems](API GetNumAuctionItems)("type")   - Returns the size of the specified auction item list.
 [GetOwnerAuctionItems](API GetOwnerAuctionItems)([page])   - ?.
 [GetSelectedAuctionItem](API GetSelectedAuctionItem)("type")   - Returns the index (1-50) of the selected auction item or 0 if none is selected.
 [IsAuctionSortReversed](API IsAuctionSortReversed)("type", "sort")   - Returns 1 if the specified auction list and sort is reversed, nil otherwise.
 [PlaceAuctionBid](API PlaceAuctionBid)("type", index, bid)   - Place a bid on the selected auction item.
 [QueryAuctionItems](API QueryAuctionItems)("name", minLevel, maxLevel, invTypeIndex, classIndex, subclassIndex, page, isUsable, qualityIndex)   - ?.
 [SetSelectedAuctionItem](API SetSelectedAuctionItem)("type", index)   - ?.
 [SortAuctionItems](API SortAuctionItems)("type", "sort")   - Request that the specified auction list be sorted by a specific column.
 [StartAuction](API StartAuction)(minBid, buyoutPrice, runTime)   - Starts the auction you have created in the Create Auction panel.
 UI [AuctionFrameAuctions.duration](API AuctionFrameAuctions.duration) - Set the amount of time the auction will run for in minutes.

## Bank Functions
 [BankButtonIDToInvSlotID](API BankButtonIDToInvSlotID)(buttonID)   - Returns the ID number of a bank button in terms of inventory slot ID.
 [CloseBankFrame](API CloseBankFrame)()   - Close the bank frame if it's open. --Ramble
 [GetBankSlotCost](API GetBankSlotCost)(numSlots)   - Returns the cost of the next bank slot. --Ramble
 [GetNumBankSlots](API GetNumBankSlots)()   - Returns total purchased bank bag slots, and a flag indicating if it's full.
 [PurchaseSlot](API PurchaseSlot)()   - Buys another bank slot if available..
...
## Buff/Debuff Functions
 [CancelPlayerBuff](API CancelPlayerBuff)(buffIndex)   - Removes a specific buff from the player.
 [CancelTrackingBuff()](API CancelTrackingBuff)   - Cancels your current tracking buff (Find Minerals etc.)
 [GetPlayerBuff](API GetPlayerBuff)(buffId, buffFilter)   - Retrieves info about a certain effect (beneficial, harmful or passive)
 [GetPlayerBuffApplications](API GetPlayerBuffApplications)(buffIndex)   - Retrieves the number of applications of a debuff or buff.
 [GetPlayerBuffDispelType](API GetPlayerBuffDispelType)(buffIndex)   - Get the debuff type for a player debuff ("Magic", "Curse", "Disease", or "Poison")
 [GetPlayerBuffTexture](API GetPlayerBuffTexture)(buffIndex)   - Retrieves the texture identifier for a certain buff
 [GetPlayerBuffTimeLeft](API GetPlayerBuffTimeLeft)(buffIndex)   - Retrieves how long a buff will last before expiring
 [GetWeaponEnchantInfo()](API GetWeaponEnchantInfo)   - Return information about main and offhand weapon enchantments.
 [UnitBuff](API UnitBuff)("[unit](API Type UnitId)", index[, showCastable])   - Retrieves info about a buff of a certain unit.
 [UnitDebuff](API UnitDebuff)("[unit](API Type UnitId)", index[, showDispellable])   - Retrieves info about a debuff of a certain unit.
...
These are chat functions which are specific to channels.
 ...
 [GetChannelName](API GetChannelName)("channel" or index)   - Retrieves the name from a specific channel.
...
## Character Functions
 ...
 [GetBlockChance](API GetBlockChance)()   - Returns the player's percentage block chance.
 [GetComboPoints](API GetComboPoints)()   - Get the current number of combo points.
 ...
 [GetDodgeChance](API GetDodgeChance)()   - Returns the player's percentage dodge chance.
 GetMoney()   - Returns an integer value of your held money in copper.
 [GetParryChance](API GetParryChance)()   - Returns the player's percentage parry chance.
 GetReleaseTimeRemaining()   - Returns the amount of time left before your ghost is pulled from your body.
 GetResSicknessDuration()
 GetRestState()
 GetTimeToWellRested()
 [GetXPExhaustion](API GetXPExhaustion)()   - Returns your character's current rested XP, nil if character is not rested.
 HasFullControl()
 HasSoulstone()
 IsResting()
...
These are the functions which communicate with other players.
 [DoEmote](API DoEmote)("emote"[, "target"])   - Perform a voice emote, optionally at a specific target.
 [GetDefaultLanguage](API GetDefaultLanguage)("[unit](API Type UnitId)")   - Returns the default language that the unit is speaking after logon.
 [GetLanguageByIndex](API GetLanguageByIndex)(index)   - Returns the language specified by the index.
 ...
 [RandomRoll](API RandomRoll)(low, high)   - Does a random roll between the two values.
 [SendAddonMessage](API SendAddonMessage)("prefix", "text", "type")   - Sends a message to hidden AddOn channels.   - Added in 1.12
 [SendChatMessage](API SendChatMessage)("text"[, "type"[, language[, targetPlayer]]])   - Sends a chat message.

## Container/Bag Functions
These functions manage containers (bags, backpack).
 [ContainerIDToInventoryID](API ContainerIDToInventoryID)([bagID](API Type BagId))
 [GetBagName](API GetBagName)([bagID](API Type BagId))   - Get the name of one of the player's bags.
 [GetContainerItemCooldown](API GetContainerItemCooldown)([bagID](API Type BagId), slot)
 [GetContainerItemInfo](API GetContainerItemInfo)([bagID](API Type BagId), slot)   - Get the info for an item in one of the player's bags.
 [GetContainerItemLink](API GetContainerItemLink)([bagID](API Type BagId), slot)   - Returns the [itemLink](API Type ItemLink) of the item located in bag#, slot#.
 [GetContainerNumSlots](API GetContainerNumSlots)([bagID](API Type BagId))   - Gives you the number of slots available in the bag specified by the index.
 [HasKey](API HasKey)()   - Returns 1 if the player has a keyring, nil otherwise.
 UI [OpenAllBags](API OpenAllBags)()   - Open/Close all bags
 [PickupBagFromSlot](API PickupBagFromSlot)(slot)   - Picks up the bag from the specified slot, placing it in the cursor. If an item is already picked up, this places the item into the specified slot, swapping the items if needed.
 [PickupContainerItem](API PickupContainerItem)([bagID](API Type BagId),slot)
 [PutItemInBackpack](API PutItemInBackpack)()   - attempts to place item in backpack (bag slot 0).
 [PutItemInBag](API PutItemInBag)(inventoryId)   - attempts to place item in a specific bag.
 [SetBagPortaitTexture](API SetBagPortaitTexture)(texture,slot)
 [SplitContainerItem](API SplitContainerItem)([bagID](API Type BagId),slot,amount)
 UI [ToggleBackpack](API ToggleBackpack)()   - Toggles your backpack open/closed.
 UI [ToggleBag](API ToggleBag)([bagID](API Type BagId))   - Opens or closes the specified bag.
 [UseContainerItem](API UseContainerItem)([bagID](API Type BagId), slot[, onSelf])   - Uses an item located in bag# and slot#. (Warning: If a vendor window is open, using items in your pack may sell them!)   - 'onSelf' added in 1.12
...
These superseded the older crafting functions for all skills, except for enchanting and the hunters train-pet-window. Most functions only work if the window for enchants is opened in the GUI. You can check whether the window is opened by using GetCraftSkillLine().
 ...
 GetCraftIcon(index)
 [GetCraftInfo](API GetCraftInfo)(index)
 GetCraftItemLink(index)   - Returns an [itemLink](API Type ItemLink) for the specified craftable item.
 GetCraftName()
 GetCraftNumReagents(index)
 GetCraftReagentInfo(index,reagentIndex)
 GetCraftReagentItemLink(index,reagentIndex)   - Returns an [itemLink](API Type ItemLink) for one of the reagents needed to craft the given item
...
## Cursor Functions
 [AutoEquipCursorItem](API AutoEquipCursorItem)()   - Causes the equipment on the cursor to be equipped.
 ClearCursor()   - Clears whatever item the cursor is dragging from the cursor.   - Added in 1.12
 CursorCanGoInSlot([invSlot](API Type InventorySlotId))   - Return true if the item currently held by the cursor can go into the given inventory (equipment) slot
 [CursorHasItem](API CursorHasItem)()   - Returns true if the cursor currently holds an item
 CursorHasMoney()   - true/false
 CursorHasSpell()   - true/false
 DeleteCursorItem()
 DropCursorMoney - Drops the amount of money held by the cursor.
 DropItemOnUnit("[unit](API Type UnitId)")   - Drops an item from the cursor onto a unit.
 EquipCursorItem([invSlot](API Type InventorySlotId))
 ...
 PickupContainerItem([bagID](API Type BagId),slot)
 PickupInventoryItem([invSlot](API Type InventorySlotId))   - "Picks up" an item from the player's worn inventory.
...
## Debugging Functions
 [debugprofilestart](API debugprofilestart)()   - starts a timer for profiling during debugging.
 [debugprofilestop](API debugprofilestop)()   - return the time in milliseconds since the last call to debugprofilestart()
 [FrameXML_Debug](API FrameXML Debug)(flag)   - Sets FrameXML logging state which is output to /WoW Folder/Logs/FrameXML.log
 GetDebugStats()
 [debugstack](API debugstack)(start, count1, count2)   - Returns a string representation of the current calling stack (as of 1.9)
...
Functions Controling the Dressing Room interface. NEW in 1700.
 UI [DressUpItem](API DressUpItem)(itemId)   - Will show the DressingRoom UI with the given item ID equipped.
 UI [DressUpItemLink](API DressUpItemLink)("[itemString](itemString)" or "[itemLink](API Type ItemLink)")   - Will show the DressingRoom UI with the given item equipped.
 UI [SetDressUpBackground](API SetDressUpBackground)(isAuctionFrame)   - Given an Item shown in the Auction House will show the DressingRoom UI with the item equiped.
...
## Faction Functions
 ...
 UnitFactionGroup("[unit](API Type UnitId)")   - Returns the faction group id and name of the specified unit. (eg. "Alliance")   - string returned is localization-independent (used in filepath)

## Frame Management
 [CreateFrame](API CreateFrame)("frameType"[ ,"name"][, parent][, "inheritFrame"])   - Create a new frame of the specified type
 [CreateFont](API CreateFont)("name")   - Dynamically create a font object
 [GetNumFrames](API GetNumFrames)()   - Get the current number of Frame (and derivative) objects
 [EnumerateFrames](API EnumerateFrames)(currentFrame)   - Get the Frame which follows currentFrame
 [GetMouseFocus()](API GetMouseFocus)   - Returns the frame that currently has the mouse focus.
 UI [MouseIsOver](API MouseIsOver) - Determines whether or not the mouse is over the specified frame.
 UI [ToggleDropDownMenu](API ToggleDropDownMenu)(level, value, dropDownFrame, anchorName, xOffset, yOffset)
 UI [UIFrameFadeIn](API UIFrameFadeIn)(frame, fadeTime, startAlpha, endAlpha)
 UI [UIFrameFlash](API UIFrameFlash)(...)
...
## Group Functions
 ...
 GetLookingForGroup()
 [GetLootMethod](API GetLootMethod)()   - Return the currently active [lootMethod](API Type LootMethod)
 ...
 [GetNumPartyMembers](API GetNumPartyMembers)()   - Returns the number of party members
 ...
 InviteToParty("[unit](API Type UnitId)")   - Invite a unit to a party by its unit id (likely "target")
 ...
 PromoteToPartyLeader("[unit](API Type UnitId)")   - Promote a unit to party leader.
 SetLookingForGroup(flag)
 SetLootMethod("[lootMethod](API Type LootMethod)"[, "masterPlayer" or threshold])   - Set the current loot method
 ...
 UninviteFromParty("[unit](API Type UnitId)")   - Kick a unit from the party if player is group leader.
 UnitInParty("[unit](API Type UnitId)")   - Returns true if the unit is a member of your party.
 UnitIsPartyLeader("[unit](API Type UnitId)")   - Returns true if the unit is the leader of its party.
...
## Guild Functions
 ...
 GetGuildInfo("[unit](API Type UnitId)")   - This function returns the name of the guild unit belongs to.
...
## Honor Functions
 ...
 UnitIsCivilian("[unit](API Type UnitId)")   - Returns true if the unit is a civilian NPC.
 UnitPVPName("[unit](API Type UnitId)")   - Returns unit's name with PvP rank prefix (e.g., "Corporal Allianceguy").
 UnitPVPRank("[unit](API Type UnitId)")   - Get PvP rank information for requested unit.
...
## Inspection Functions
 [CheckInteractDistance](API CheckInteractDistance)("[unit](API Type UnitId)",distIndex)
 ClearInspectPlayer()   - Reset inspect data once finished with it (Called on inspect window hide)
 GetInspectHonorData()   - Return honor info for the inspected unit (if available).
 GetInspectPVPRankProgress()   - Return rank progress for the inspected unit (if available). Ranges from 0 to 1.
 HasInspectHonorData()   - Determine if the inspected unit's honor data is available.
 UI [InspectUnit](API InspectUnit)("[unit](API Type UnitId)")   - Inspects the specified / selected "unit".
 NotifyInspect("[unit](API Type UnitId)")
 RequestInspectHonorData()   - Request honor data for inspected unit.
...
These functions manage your "inventory", that is, equipped items, as opposed to in nearly every other game where "inventory" refers to things you carry in your backpack.
 ...
 ConfirmBindOnUse()
 ContainerIDToInventoryID([bagID](API Type BagId))
 CursorCanGoInSlot([invSlot](API Type InventorySlotId))   - Return true if the item currently held by the cursor can go into the given inventory (equipment) slot
 EquipCursorItem([invSlot](API Type InventorySlotId))
 EquipPendingItem([invSlot](API Type InventorySlotId))   - Equips the currently pending Bind-on-Equip or Bind-on-Pickup item from the specified inventory slot. (Internal - do not use)
 GetInventoryAlertStatus(index)   - Returns one of several codes describing the "status" of an equipped item.
 GetInventoryItemBroken("[unit](API Type UnitId)",[invSlot](API Type InventorySlotId))   - Determine if an inventory item is broken (no durability).
 GetInventoryItemCooldown("[unit](API Type UnitId)",[invSlot](API Type InventorySlotId))   - Get cooldown information for an inventory item.
 GetInventoryItemCount("[unit](API Type UnitId)",[invSlot](API Type InventorySlotId))   - Determine the quantity of an item in an inventory slot.
 [GetInventoryItemLink](API GetInventoryItemLink)("[unit](API Type UnitId)",[invSlot](API Type InventorySlotId))   - Returns an [itemLink](API Type ItemLink) for an inventory (equipped) item.
 GetInventoryItemQuality("[unit](API Type UnitId)",[invSlot](API Type InventorySlotId))   - Return the quality of an inventory item.
 GetInventoryItemTexture("[unit](API Type UnitId)",[invSlot](API Type InventorySlotId))   - Return the texture for an inventory item.
 [GetInventorySlotInfo](API GetInventorySlotInfo)([invSlotName](API Type InventorySlotName))   - Get the info for a named inventory slot (slot ID and texture)
 ...
 UseInventoryItem([invSlot](API Type InventorySlotId))   - Use an item in a specific inventory slot.

## Item Functions
These functions are those which operate on item links or item information directly.
 GetAuctionItemLink("type", index)   - Returns an [itemLink](API Type ItemLink) for the specified auction item.
 GetContainerItemLink([bagID](API Type BagId), slot)   - Returns the [itemLink](API Type ItemLink) of the item located in bag#, slot#.
 GetCraftItemLink(index)   - Returns an [itemLink](API Type ItemLink) for the specified craftable item.
 GetCraftReagentItemLink(index,reagentIndex)   - Returns an [itemLink](API Type ItemLink) for one of the reagents needed to craft the given item
 GetInventoryItemLink("[unit](API Type UnitId)",[invSlot](API Type InventorySlotId))   - Returns an [itemLink](API Type ItemLink) for an inventory (equipped) item.
 [GetItemInfo](API GetItemInfo)(itemId or "[itemString](itemString)")   - Returns information about an item.
 GetItemQualityColor(quality)   - Returns the RGB color codes for a quality.
 GetMerchantItemLink(index)   - Returns an [itemLink](API Type ItemLink) for the given purchasable item
 GetQuestItemLink - Returns an [itemLink](API Type ItemLink) for a quest reward item.
 GetQuestLogItemLink - ?.
 GetTradePlayerItemLink(id)   - Returns an [itemLink](API Type ItemLink) for the given item in your side of the trade window (if open)
 GetTradeSkillItemLink(index)   - Returns the [itemLink](API Type ItemLink) for a trade skill item.
 GetTradeSkillReagentItemLink(index, reagentId)   - Returns the [itemLink](API Type ItemLink) for one of the reagents needed to craft the given item
 GetTradeTargetItemLink(id)   - Returns an [itemLink](API Type ItemLink) for the given item in the other player's side of the trade window (if open)
...
These functions are related to the current location of the player and how it is displayed. Globals associated with Location. Events associated with Location.
 [GetMinimapZoneText](API GetMinimapZoneText)()   - Returns the zone text, that is displayed over the minimap.
 [GetRealZoneText](API GetRealZoneText)()   - Returns either instance name or zone name
 [GetSubZoneText](API GetSubZoneText)()   - Returns the subzone text (e.g. "The Canals").
 [GetZonePVPInfo](API GetZonePVPInfo)()   - Returns PVP info for the current zone.
 [GetZoneText](API GetZoneText)()   - Returns the zone text (e.g. "Stormwind City").
...
## Loot Functions
 ...
 GetLootSlotLink(slot)   - Returns an [itemLink](API Type ItemLink) for the item in the given loot window slot
 GetLootThreshold()   - Return the current loot threshold (for group/master loot)
 GetMasterLootCandidate(index)   - Return the name of a player who is eligible to receive loot in master mode
...
## Lottery Functions
 [BuyRandomPicks](API BuyRandomPicks) - ?   - Added in 1.12
...
## Macro Functions
 [CreateMacro](API CreateMacro)("name", icon, "body", local)   - Create a new macro.
 DeleteMacro(index)   - Deletes a macro.
 [EditMacro](API EditMacro)(index, "name", iconIndex, "body", local)   - Saves a macro.
 GetMacroIconInfo(index)   - Returns texture of the icons provided by Blizzard.
 GetMacroIndexByName("name")   - Returns macro index.
 [GetMacroInfo](API GetMacroInfo)(index)   - Returns "name", iconTextureID, "body", local.
...
These functions are related to display of the world map.
 ...
 GetPlayerMapPosition("[unit](API Type UnitId)")   - Returns the position of a unit on the current world map.
 ...
 RequestBattlefieldPositions()   - Request new data for GetBattlefieldPosition().
 [SetMapToCurrentZone](API SetMapToCurrentZone)()   - Sets the current world map to the zone the player is presently in.
...
## Merchant Functions
 [BuyMerchantItem](API BuyMerchantItem)(index[, qty])   - Buys an item from a merchant.
 ...
 [GetMerchantItemInfo](API GetMerchantItemInfo)(index)   - Returns information about the given purchasable item
 GetMerchantItemLink(index)   - Returns an [itemLink](API Type ItemLink) for the given purchasable item
...
Use with caution - movement started by a script must be stopped by script. Keys/Mouse will not stop movement. These functions no longer work (fail silently) in patch 1.6 if NOT triggered from a hardware event (just like spell casts). As of patch 1.10 many of these functions were protected for use of only Blizzard signed code.
 ...
 FollowUnit("[unit](API Type UnitId)")   - Follow an ally with the specified UnitID
...
## Pet Functions
 BuyStableSlot()
 [CastPetAction](API CastPetAction)(index)   - Cast the corresponding pet skill.
 ...
 [GetPetActionInfo](API GetPetActionInfo)(index)   - Returns information on the pet action at the specified pet action bar slot.
 ...
 [HasPetUI](API HasPetUI)()   - Returns true if the player has a pet User Interface.
 PetAbandon()   - Permanently abandons your pet.
 PetAggressiveMode()   - Set your pet in aggressive mode.
 [PetAttack](API PetAttack)()   - Instruct your pet to attack your target.
 ...
 [ToggleSpellAutocast](API ToggleSpellAutocast)(index, bookIndex)   - Toggles whether the specified pet ability should autocast or not. (in the spellbook).
 [GetSpellAutocast](API GetSpellAutocast)(index, bookIndex)   - Check wether the specified pet ability autocasts or not.
 UnstablePet(index)   - ?
...
## Quest Functions
 [AbandonQuest](API AbandonQuest) - Abandon the specified quest.
 [AcceptQuest](API AcceptQuest) - Accept the specified quest.
 [AddQuestWatch](API AddQuestWatch)(x)   - Add a quest to the watch list.
 [CloseQuest](API CloseQuest) - ?.
 [CollapseQuestHeader](API CollapseQuestHeader) - Collapses a quest header.
 [CompleteQuest](API CompleteQuest) - Complete the specified quest.
 [ConfirmAcceptQuest](API ConfirmAcceptQuest) - Accept the quest. Yes. Really accept it.
 [DeclineQuest](API DeclineQuest) - Declines the currently offered quest.
 [ExpandQuestHeader](API ExpandQuestHeader) - Expands a quest header.
 [GetAbandonQuestName](API GetAbandonQuestName) - Gets the name of a quest while it is being abandoned.
 [GetActiveLevel](API GetActiveLevel)(index) - Gets the level of an active quest (only available after QUEST_GREETING event).
 [GetActiveTitle](API GetActiveTitle)(index) - Gets the title of an active quest (only available after QUEST_GREETING event).
 [GetAvailableLevel](API GetAvailableLevel)(index) - Gets the level of an available quest (only available after QUEST_GREETING event).
 [GetAvailableTitle](API GetAvailableTitle)(index) - Gets the title of an available quest (only available after QUEST_GREETING event).
 [GetGreetingText](API GetGreetingText)()
 [GetNumActiveQuests](API GetNumActiveQuests) - Gets the number of currently active quests from this NPC (only available after QUEST_GREETING event).
 [GetNumAvailableQuests](API GetNumAvailableQuests) - Gets the number of currently available quests from this NPC (only available after QUEST_GREETING event).
 [GetNumQuestChoices](API GetNumQuestChoices) - Returns the number of rewards for a completed quest.
 [GetNumQuestItems](API GetNumQuestItems) - Returns the number of items nessecary to complete a particular quest.
 [GetNumQuestLeaderBoards](API GetNumQuestLeaderBoards)([questIndex])   - Returns the number of available quest objectives.
 [GetNumQuestLogChoices](API GetNumQuestLogChoices) - Returns the number of options someone has when getting a quest item.
 [GetNumQuestLogEntries](API GetNumQuestLogEntries) - Returns the number of entries in the quest log.
 [GetNumQuestLogRewards](API GetNumQuestLogRewards) - Returns the count of the rewards for a particular quest.
 [GetNumQuestRewards](API GetNumQuestRewards) - ?.
 [GetNumQuestWatches](API GetNumQuestWatches)()   - Returns the number of quest watches active.
 [GetObjectiveText](API GetObjectiveText)()   - Gets the objective of the current quest.
 [GetProgressText](API GetProgressText)()
 [GetQuestBackgroundMaterial](API GetQuestBackgroundMaterial) - Returns the material string associated with the particular quest.
 [GetQuestGreenRange](API GetQuestGreenRange)()   - Return for how many levels below you quests and mobs remain "green" (i.e. yield xp)
 [GetQuestIndexForTimer](API GetQuestIndexForTimer) - ?.
 [GetQuestIndexForWatch](API GetQuestIndexForWatch)(watchIndx)   - Return the quest index for the specified watch
 [GetQuestItemInfo](API GetQuestItemInfo) - Returns basic information about the quest items.
 [GetQuestItemLink](API GetQuestItemLink) - Returns an [itemLink](API Type ItemLink) for a quest reward item.
 [GetQuestLogChoiceInfo](API GetQuestLogChoiceInfo) - Returns a bunch of data about a quest reward choice from the quest log.
 [GetQuestLogItemLink](API GetQuestLogItemLink) - ?.
 [GetQuestLogLeaderBoard](API GetQuestLogLeaderBoard)(ldrIndex[, questIndex])   - Gets information about the objectives for a quest.
 [GetQuestLogPushable](API GetQuestLogPushable) - Returns true if the currently loaded quest in the quest window can be shared.
 [GetQuestLogQuestText](API GetQuestLogQuestText) - Returns the description and objectives required for the specified quest.
 [GetQuestLogRequiredMoney](API GetQuestLogRequiredMoney) - ?.
 [GetQuestLogRewardInfo](API GetQuestLogRewardInfo) - Returns a pile of reward item info.
 [GetQuestLogRewardMoney](API GetQuestLogRewardMoney) - Returns a number representing the amount of copper returned by a particular quest.
 [GetQuestLogRewardSpell](API GetQuestLogRewardSpell) - ?.
 [GetQuestLogSelection](API GetQuestLogSelection) - Returns a number associated with the QuestLogSelection index.
 [GetQuestLogTimeLeft](API GetQuestLogTimeLeft) - ?.
 [GetQuestLogTitle](API GetQuestLogTitle) - Returns the string which is associated with the specific QuestLog Title in the game.
 [GetQuestMoneyToGet](API GetQuestMoneyToGet) - ?
 [GetQuestReward](API GetQuestReward) - Gets the quest reward specified.
 [GetQuestText](API GetQuestText) - Gets the description of the current quest.
 [GetQuestTimers](API GetQuestTimers) - Returns all of the quest timers currently in progress.
 [GetRewardMoney](API GetRewardMoney) - Returns a number representing the amount of copper returned by a particular quest.
 [GetRewardSpell](API GetRewardSpell) - ?.
 [GetRewardText](API GetRewardText) - ?.
 [GetTitleText](API GetTitleText) - Retrieves the title of the quest while talking to the NPC about it.
 [IsCurrentQuestFailed](API IsCurrentQuestFailed) - ?.
 [IsQuestCompletable](API IsQuestCompletable) - Returns true if a quest is possible to complete.
 [IsQuestWatched](API IsQuestWatched)(questIndex)   - Determine if the specified quest is watched.
 [IsUnitOnQuest](API IsUnitOnQuest)(questIndex, "[unit](API Type UnitId)")   - Determine if the specified unit is on the given quest.
 [QuestChooseRewardError](API QuestChooseRewardError) - Throws an error when the quest choose reward method doesn't work.
 [QuestLogPushQuest](API QuestLogPushQuest) - Initiates the sharing of the currently viewed quest in the quest log.
 [RemoveQuestWatch](API RemoveQuestWatch)(index)   - Remove a quest watch (Is the index a quest or watch index?).
 [SelectActiveQuest](API SelectActiveQuest) - Selects an active quest from the NPC (only available after QUEST_GREETING event).
 [SelectAvailableQuest](API SelectAvailableQuest) - Selects an available quest from the NPC (only available after QUEST_GREETING event).
 [SelectQuestLogEntry](API SelectQuestLogEntry) - ?.
 [SetAbandonQuest](API SetAbandonQuest) - Called before [AbandonQuest](API AbandonQuest).
 UI [ToggleQuestLog](API ToggleQuestLog) - Opens/closes the quest log.
...
## Raid Functions
 ...
 [GetRaidRosterInfo](API GetRaidRosterInfo)(index)   - Returns information about the members of your raid .
 GetRaidRosterSelection - ?.
 GetRaidTargetIndex("[unit](API Type UnitId)")   - Get the raid target index assigned to a unit.
 ...
 SetRaidTarget("[unit](API Type UnitId)", index)   - Set the raid target index for a unit.
 UninviteFromRaid(index)   - Boots someone from a raid
 UnitInRaid("[unit](API Type UnitId)")   - Returns 1 if unit is in your raid, nil if not.
...
## Settings Functions
 ...
 [SetCVar](API SetCVar)("cvar", value[, "scriptCVar"])   - Set the value of a variable in config.wtf
 SetDoodadAnim()   - ?.
...
spellID is the index of a spell in a spellbook. The indices increase from top to bottom, then left to right, then between categories (e.g.: General -> Discipline). spellIDs will change as players learn new spells and professions.
 [CastShapeshiftForm](API CastShapeshiftForm)(index)
 CastSpell(spellID, "bookType")   - Cast the specified spell by ID. spellbookTab is "spell" or "pet".
 [CastSpellByName](API CastSpellByName)("name"[, onSelf])   - Cast the specified spell by display name.
 GetCraftSpellFocus(index)   - ?.
 ...
 [GetSpellCooldown](API GetSpellCooldown)(spellID, "bookType")   - Retrieves data on the cooldown of a specific spell within your spellbook..
 [GetSpellName](API GetSpellName)(spellID, "bookType")   - Returns the spell name and spell rank for a spell in the player's spellbook.
 [GetSpellTabInfo](API GetSpellTabInfo)(spellbookTabNum)   - Returns information about the specified spellbook tab.
 GetSpellTexture(spellID, "bookType")   - ?.
 [GetTrackingTexture](API GetTrackingTexture)()   - Return the texture of the current tracking buff, if one is active.
 ...
 PickupSpell(spellID, "bookType")   - Loads an action button onto the cursor to be dropped into a quickbar slot.
 PlayerHasSpells()   - ?.
 SpellCanTargetUnit("[unit](API Type UnitId)")   - Returns true if the spell awaiting target selection can be cast on the specified unit.
 [SpellIsTargeting](API SpellIsTargeting)()   - Returns true if a spell has been cast and is awaiting target selection.
 ...
 [SpellStopTargeting](API SpellStopTargeting)()   - Cancels the spell awaiting target selection.
 [SpellTargetUnit](API SpellTargetUnit)("[unit](API Type UnitId)")   - Casts the spell awaiting target selection on the specified unit.
...
## System Functions
 ...
 [GetLocale](API GetLocale)()   - Returns client locale, example 'enUS'.
 GetCursorPosition()   - Returns the cursor's position on the screen.
 ...
 UI [GetText](API GetText)()   - Used to localize some client text.
 [GetTime](API GetTime)()   - Returns the system uptime in seconds (millisecond precision).
 InCinematic()
 ...
 [PlayMusic](API PlayMusic)()   - Plays the specified mp3.
 [PlaySound](API PlaySound)()   - Plays the specified built-in sound effect.
 [PlaySoundFile](API PlaySoundFile)()   - Plays the specified sound file.
 ...
 StopCinematic()
 [StopMusic](API StopMusic)()   - Stops the currently playing mp3.
 ...
 debuginfo()   - Output win32 debug text. Freeware debug message viewer: [DebugView](https://web.archive.org/web/20061116163316/http://www.sysinternals.com/Utilities/DebugView.html) (Has no effect on live server)
...
## Targetting Functions
 [AssistByName](API AssistByName)("playername")   - Assists the player whose name is entered.
 [AssistUnit](API AssistUnit)("[unit](API Type UnitId)")   - Instructs your character to assist the specified unit.
 [AttackTarget](API AttackTarget)()   - Attacks the targetted unit.
 [ClearTarget](API ClearTarget)()   - Clears the selected target.
 [ClickTargetTradeButton](API ClickTargetTradeButton)(index)
 [TargetByName](API TargetByName)("name"[, exactMatch])   - Selects the specified player as the current target.
 [TargetLastEnemy](API TargetLastEnemy)()   - Selects the last targetted enemy as the current target.
 [TargetLastTarget](API TargetLastTarget)()   - Selects the last target as the current target.
 [TargetNearestEnemy](API TargetNearestEnemy)([reverseFlag])   - Selects the nearest enemy as the current target.
 [TargetNearestFriend](API TargetNearestFriend)()   - Selects the nearest friendly unit as the current target.
 [TargetNearestPartyMember](API TargetNearestPartyMember)()   - Selects the nearest Party member as the current target.
 TargetNearestRaidMember - Selects the nearest Raid member as the current target.
 [TargetUnit](API TargetUnit)("[unit](API Type UnitId)")   - Selects the specified unit as the current target.
...
## Taxi Functions
 ...
 UnitOnTaxi("[unit](API Type UnitId)")   - Returns 1 if unit is on a taxi.

## Toggle Functions
 UI ToggleBackpack()   - Toggles your backpack open/closed.
 UI ToggleBag([bagID](API Type BagId))   - Opens or closes the specified bag.
...
## TradeSkill Functions
 ...
 [DoTradeSkill](API DoTradeSkill)(index[, repeatTimes])   - Performs the tradeskill a specified # of times.
...
These are functions which act on one or more units. Units are identified by UnitIds.
 ...
 SpellCanTargetUnit("[unit](API Type UnitId)")   - Returns true if the spell awaiting target selection can be cast on the specified unit.
 SpellTargetUnit("[unit](API Type UnitId)")   - Casts the spell awaiting target selection on the specified unit.
 StartDuelUnit("[unit](API Type UnitId)")   - Challenge a unit to a duel.
 TargetUnit("[unit](API Type UnitId)")   - Selects the specified unit as the current target.
 [UnitAffectingCombat](API UnitAffectingCombat)("[unit](API Type UnitId)")   - Determine if the unit is in combat or has aggro. (returns nil if "false" and 1 if "true")
 UnitArmor("[unit](API Type UnitId)")   - Returns the armor statistics relevant to the specified unit.
 UnitAttackBothHands("[unit](API Type UnitId)")   - Returns information about the unit's melee attacks.
 [UnitAttackPower](API UnitAttackPower)("[unit](API Type UnitId)")   - Returns the unit's melee attack power and modifiers.
 UnitAttackSpeed("[unit](API Type UnitId)")   - Returns the unit's melee attack speed for each hand.
 UnitBuff("unit", index[, showCastable])   - Retrieves info about a buff of a certain unit.
 UnitCanAssist("[unit](API Type UnitId)", "otherUnit")   - Returns true if the first unit can assist the second, false otherwise.
 UnitCanAttack("[unit](API Type UnitId)", "otherUnit")   - Returns true if the first unit can attack the second, false otherwise.
 UnitCanCooperate("[unit](API Type UnitId)", "otherUnit")   - Returns true if the first unit can cooperate with the second, false otherwise.
 UnitCharacterPoints("[unit](API Type UnitId)")   - Returns the number of unspent talent points for the specified unit -- usually 0.
 UnitClass("[unit](API Type UnitId)")   - Returns the class name of the specified unit (e.g., "Warrior" or "Shaman").
 UnitClassification("[unit](API Type UnitId)")   - Returns the classification of the specified unit (e.g., "elite" or "worldboss").
 UnitCreatureFamily("[unit](API Type UnitId)")   - Returns the type of creature of the specified unit (e.g., "Crab").
 [UnitCreatureType](API UnitCreatureType)("[unit](API Type UnitId)")   - Returns the classification type of creature of the specified unit (e.g., "Beast").
 UnitDamage("[unit](API Type UnitId)")   - Returns the damage statistics relevant to the specified unit.
 UnitDebuff("[unit](API Type UnitId)", index[, showDispellable])   - Retrieves info about a debuff of a certain unit.
 UnitDefense("[unit](API Type UnitId)")   - Returns the base defense skill of the specified unit.
 [UnitExists](API UnitExists)("[unit](API Type UnitId)")   - Returns true if the specified unit exists, false otherwise.
 UnitFactionGroup("[unit](API Type UnitId)")   - Returns the faction group id and name of the specified unit. (eg. "Alliance")   - string returned is localization-independent (used in filepath)
 [UnitHealth](API UnitHealth)("[unit](API Type UnitId)")   - Returns the current health, in points, of the specified unit.
 UnitHealthMax("[unit](API Type UnitId)")   - Returns the maximum health, in points, of the specified unit.
 UnitInParty("[unit](API Type UnitId)")   - Returns true if the unit is a member of your party.
 UnitInRaid("[unit](API Type UnitId)")   - Returns 1 if unit is in your raid, nil if not.
 UnitIsCharmed("[unit](API Type UnitId)")   - Returns true if the specified unit is charmed, false otherwise.
 UnitIsCivilian("[unit](API Type UnitId)")   - Returns true if the unit is a civilian NPC.
 UnitIsConnected("[unit](API Type UnitId)")   - Returns 1 if the specified unit is connected or npc, nil if offline or not a valid unit.
 UnitIsCorpse("[unit](API Type UnitId)")   - Returns true if the specified unit is a corpse, false otherwise.
 [UnitIsDead](API UnitIsDead)("[unit](API Type UnitId)")   - Returns true if the specified unit is dead, nil otherwise.
 [UnitIsDeadOrGhost](API UnitIsDeadOrGhost)("[unit](API Type UnitId)")   - Returns true if the specified unit is dead or a ghost, nil otherwise.
 UnitIsEnemy("[unit](API Type UnitId)", "otherUnit")   - Returns true if the specified units are enemies, false otherwise.
 UnitIsFriend("[unit](API Type UnitId)", "otherUnit")   - Returns true if the specified units are friends (PC of same faction or friendly NPC), false otherwise.
 UnitIsGhost("[unit](API Type UnitId)")   - Returns true if the specified unit is a ghost, false otherwise.
 [UnitIsPVP](API UnitIsPVP)("[unit](API Type UnitId)")   - Returns true if the specified unit is flagged for PVP, false otherwise.
 UnitIsPVPFreeForAll("[unit](API Type UnitId)")   - Returns true if the specified unit is flagged for free-for-all PVP, false otherwise.
 UnitIsPartyLeader("[unit](API Type UnitId)")   - Returns true if the unit is the leader of its party.
 UnitIsPlayer("[unit](API Type UnitId)")   - Returns true if the specified unit is a player character, false otherwise.
 UnitIsPlusMob("[unit](API Type UnitId)")   - Returns true if the specified unit is a mob, more powerful than its nominal level, false otherwise (e.g., "elite" mobs)
 UnitIsTapped("[unit](API Type UnitId)")   - Returns true if the specified unit is tapped, false otherwise.
 UnitIsTappedByPlayer("[unit](API Type UnitId)")   - Returns true if the specified unit is tapped by the player himself, otherwise false.
 UnitIsTrivial("[unit](API Type UnitId)")   - Returns true if the specified unit is trivial (Trivial means the unit is "grey" to the player. false otherwise.
 [UnitIsUnit](API UnitIsUnit)("[unit](API Type UnitId)", "otherUnit")   - Determine if two units are the same unit.
 UnitIsVisible("[unit](API Type UnitId)")   - 1 if visible, nil if not
 UnitLevel("[unit](API Type UnitId)")   - Returns the level of a unit.
 [UnitMana](API UnitMana)("[unit](API Type UnitId)")   - Returns the current mana (or energy,rage,etc), in points, of the specified unit.
 [UnitManaMax](API UnitManaMax)("[unit](API Type UnitId)")   - Returns the maximum mana (or energy,rage,etc), in points, of the specified unit.
 [UnitName](API UnitName)("[unit](API Type UnitId)")   - Returns the name (and realm name) of a unit.
 UnitOnTaxi("[unit](API Type UnitId)")   - Returns 1 if unit is on a taxi.
 [UnitPlayerControlled](API UnitPlayerControlled)("[unit](API Type UnitId)")   - Returns true if the specified unit is controlled by a player, false otherwise.
 UnitPlayerOrPetInParty("[unit](API Type UnitId)")   - Returns 1 if the specified unit/pet is a member of the player's party, nil otherwise (returns 1 for "player" and "pet")   - Added in 1.12
 UnitPlayerOrPetInRaid("[unit](API Type UnitId)")   - Returns 1 if the specified unit/pet is a member of the player's raid, nil otherwise (returns 1 for "player" and "pet")   - Added in 1.12
 UnitPVPName("[unit](API Type UnitId)")   - Returns unit's name with PvP rank prefix (e.g., "Corporal Allianceguy").
 UnitPVPRank("[unit](API Type UnitId)")   - Get PvP rank information for requested unit.
 [UnitPowerType](API UnitPowerType)("[unit](API Type UnitId)")   - Returns a number corresponding to the power type (e.g., mana, rage or energy) of the specified unit.
 UnitRace("[unit](API Type UnitId)")   - Returns the race name of the specified unit (e.g., "Human" or "Troll").
 UnitRangedAttack("[unit](API Type UnitId)")   - Returns the ranged attack number of the unit.
 UnitRangedAttackPower("[unit](API Type UnitId)")   - Returns the ranged attack power of the unit.
 UnitRangedDamage("[unit](API Type UnitId)")   - Returns the ranged attack speed and damage of the unit.
 UnitReaction("[unit](API Type UnitId)", "otherUnit")   - Returns a number corresponding to the reaction (aggressive, neutral or friendly) of the first unit towards the second unit.
 UnitResistance("[unit](API Type UnitId)", "resistanceIndex")   - Returns the resistance statistics relevant to the specified unit and resistance type.
 UnitSex("[unit](API Type UnitId)")   - Returns a code indicating the gender of the specified unit, if known. (1=unknown, 2=male, 3=female) ← changed in 1.11!
 UnitStat("[unit](API Type UnitId)", statIndex)   - Returns the statistics relevant to the specified unit and basic attribute (e.g., strength or intellect).
 [UnitXP](API UnitXP)("[unit](API Type UnitId)")   - Returns the number of experience points the specified unit has in their current level. (only works on your player)
 [UnitXPMax](API UnitXPMax)("[unit](API Type UnitId)")   - Returns the number of experience points the specified unit needs to reach their next level. (only works on your player)
 SetPortraitTexture(texture,"[unit](API Type UnitId)")   - Paint a Texture object with the specified unit's portrait.
