---
title: "Tanaris"
url: "https://turtle-wow.fandom.com/wiki/Tanaris"
source_type: "community wiki (turtle-wow.fandom.com), not an official source"
revision: "2026-03-29T17:25:05Z"
fetched: "2026-09-10T07:39:46Z"
is_turtle_content: true
patch: "1.18.0"
categories: ["Kalimdor", "Tanaris", "Turtle WoW content"]
---
# Tanaris
...
| faction | Neutral |
| level | 40 - 50 |
| capital | Gadgetzan, Zul'Farrak |
| races | Goblin, Sand troll, Human, Ogre, Silithid, Dwarf, Gnome |
| rulers | Chief Engineer Bilgewhizzle, Ukorz Sandscalp, Andre Firebeard, Caliph Scorpidsting |
| major | Steamwheedle Port, Caverns of Time, Lost Rigger Cove |
| minor | Dunemaul Compound, Sandsorrow Watch, Sandmoon Village, Slickwick Oil Rig |
| affiliation | Steamwheedle Cartel, Sandfury tribe, Southsea Freebooters, Dunemaul clan, Wastewander, Bronze dragonflight, Durotar Labor Union, Venture Company |
...
It is home to two instance; [Zul'Farrak](Zul'Farrak) and [Caverns of Time: Black Morass](Caverns of Time: Black Morass), as well as several [micro dungeons](Elite area).

### Maps and subregions
<gallery>
WorldMap-Tanaris-old3.jpg|Tanaris prior to [patch 1.18.0](patch 1.18.0).
WorldMap-Tanaris-old2.jpg|Tanaris prior to [patch 1.16.4](patch 1.16.4).
WorldMap-Tanaris-old1.jpg|Tanaris prior to [patch 1.16.1](patch 1.16.1).
</gallery>

{| class="fandom-table"
|-
|[Abyssal Sands](Abyssal Sands) • [Broken Pillar](Broken Pillar) • [Caverns of Time](Caverns of Time) • [Dunemaul Compound](Dunemaul Compound) • [Eastmoon Ruins](Eastmoon Ruins) • [Gadgetzan](Gadgetzan) • [The Gaping Chasm](Gaping Chasm) • [Land's End Beach](Land's End Beach) • [Lost Rigger Cove](Lost Rigger Cove) • [Noonshade Ruins](Noonshade Ruins) • [The Noxious Lair](Noxious Lair) • [Sandmoon Village](Sandmoon Village) • [Sandsorrow Watch](Sandsorrow Watch) • [Slickwick Oil Rig](Slickwick Oil Rig) • [Southbreak Shore](Southbreak Shore) • [Southmoon Ruins](Southmoon Ruins) • [Steamwheedle Port](Steamwheedle Port) • [Thistleshrub Valley](Thistleshrub Valley) • [Valley of the Watchers](Valley of the Watchers) ([Uldum](Uldum)) • [Waterspring Field](Waterspring Field) • [Wavestrider Beach](Wavestrider Beach) ([Zalashji's Den](Zalashji's Den)) • [Zul'Farrak](Zul'Farrak)
|}
...
|-
| [Zul'Farrak](Zul'Farrak) || 43-48
| 5-man
| 3-4 Hours
|-
| [Caverns of Time: Black Morass](Caverns of Time: Black Morass) || 60
| 5-man
| 2-3.5 Hours
|}
...
| 
| 25-35 || North
| By foot or Horde flightpath from [Gadgetzan](Gadgetzan) to [Freewind Post](Freewind Post).
|-
| [Un'Goro Crater](Un'Goro Crater)
| 
| 50-55 || West
| By foot or flightpaths from Gadgetzan to [Marshal's Refuge](Marshal's Refuge).
|-
| [Tel'Abim](Tel'Abim)
| 
| 54-60 || East
| By swimming or flightpaths from Gadgetzan to [Tel Co. Basecamp](Tel Co. Basecamp).
|}
...
## Notes
- Since [Alliance](Alliance) has no travel hub in [Thousand Needles](Thousand Needles), [Gadgetzan](Gadgetzan) makes a great alternative to get to the [Shimmering Flats](Shimmering Flats) since it is just a short run over the hill to get there. Even [Horde](Horde) can benefit from this shortcut as it is even faster than running from [Freewind Post](Freewind Post).
