---
title: "Feralas"
url: "https://turtle-wow.fandom.com/wiki/Feralas"
source_type: "community wiki (turtle-wow.fandom.com), not an official source"
revision: "2026-03-29T17:23:55Z"
fetched: "2026-09-10T07:38:47Z"
is_turtle_content: true
patch: "1.17.0"
categories: ["Feralas", "Kalimdor", "Turtle WoW content"]
---
# Feralas
...
| name | Feralas |
| level | 40 - 50 |
| ss | High Wilderness.jpg |
| capital | Dire Maul |
| races | Ogre, Tauren, Night elf, Naga, Harpy, Sea giant |
| loc | Northwestern Southern Kalimdor |
| major | Camp Mojache, Feathermoon Stronghold, Isle of Dread |
| minor | Chimaera Roost Vale |
...
[Dire Maul](Dire Maul), ancient ruins now populated by ogres, is an instanced dungeon which can be found in this area. There are no raid dungeons or battlegrounds here, but there are multiple [micro dungeons](Dungeon).

### Maps and subregions
<gallery>
WorldMap-Feralas-old.jpg|Map of Feralas prior to [patch 1.17.0](patch 1.17.0).
</gallery>

{| class="fandom-table"
|-
|[Camp Mojache](Camp Mojache) • [Chimaera Roost Vale](Chimaera Roost Vale) • [Dire Maul](Dire Maul) ([Broken Commons](Broken Commons) • [Eldreth Row](Eldreth Row) • [The Maul](Maul (subzone))) • [The Forgotten Coast](Forgotten Coast) • [Gordunni Outpost](Gordunni Outpost) • [Grimtotem Compound](Grimtotem Compound) • [The Hidden Reach](Hidden Reach) • [High Wilderness](High Wilderness) ([Feral Scar Vale](Feral Scar Vale) • [Frayfeather Highlands](Frayfeather Highlands) • [Ruins of Isildien](Ruins of Isildien)) • [Isle of Dread](Isle of Dread) ([Shalzaru's Lair](Shalzaru's Lair)) • [Jademir Lake](Jademir Lake) ([Dream Bough](Dream Bough)) • [Lariss Pavilion](Lariss Pavilion) • [Lower Wilds](Lower Wilds) ([Feralkin Cave](Feralkin Cave) • [Thalanaar](Thalanaar)) • [Oneiros](Oneiros) • [Rage Scar Hold](Rage Scar Hold) • [Ruins of Ravenwind](Ruins of Ravenwind) • [Sardor Isle](Sardor Isle) ([Feathermoon Stronghold](Feathermoon Stronghold) • [Ruins of Solarsal](Ruins of Solarsal)) • [The Twin Colossals](Twin Colossals) • [Verdantis River](Verdantis River) • [Wildwind Lake](Wildwind Lake) • [Woodpaw Hills](Woodpaw Hills) ([Woodpaw Den](Woodpaw Den) • [The Writhing Deep](Writhing Deep))
|}
...
- [Thalanaar](Thalanaar), Feralas
- [Cenarion Hold](Cenarion Hold), [Silithus](Silithus)

#### [Flight path](Flight path)s from [Thalanaar](Thalanaar)
- [Theramore Isle](Theramore Isle), [Dustwallow Marsh](Dustwallow Marsh)
- [Feathermoon Stronghold](Feathermoon Stronghold), Feralas
- [Gadgetzan](Gadgetzan), [Tanaris](Tanaris)

#### [Flight path](Flight path)s from [Camp Mojache](Camp Mojache)
...
|  
| 25-35 || East
| By foot or by Horde flightpath from [Camp Mojache](Camp Mojache) to [Freewind Post](Freewind Post).
|-
| [Desolace](Desolace)
|  
| 30-40 || North
| By foot or by flightpaths from [Camp Mojache](Camp Mojache) to [Shadowprey Village](Shadowprey Village) or from [Feathermoon Stronghold](Feathermoon Stronghold) to [Nijel's Point](Nijel's Point).
|}
...
## Notes
- Feralas is the location of one of the four [Great Trees](Great Trees) leading to the [Emerald Dream](Emerald Dream) and guarded by the four Emerald Dragons. The three others are in [Ashenvale](Ashenvale), [Duskwood](Duskwood), and [the Hinterlands](Hinterlands).
- Per [Simple Sigil](Simple Sigil), it was considered "lost" to the night elves until after the [Third War](Third War).

## Patch changes
- (Patch 1.17.0|note=[Chimaera Roost Vale](Chimaera Roost Vale) added.)
