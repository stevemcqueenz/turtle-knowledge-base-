...
url: "https://turtle-wow.fandom.com/wiki/Your_Place_In_The_World"
source_type: "community wiki (turtle-wow.fandom.com), not an official source"
revision: "2025-12-25T02:59:15Z"
fetched: "2026-09-10T07:40:02Z"
is_turtle_content: false
patch: null
categories: ["Durotar quests", "Horde quests", "Quests at 1"]
---
...
| end | Gornek |
| experience | 40 |
| reputation | +50 Orgrimmar & Darkspear Trolls |
| next | Cutting Teeth |

## Objectives
Speak with [Gornek](Gornek). You recall Kaltunk marking your map with his location and mentioning that gornek resides in the Den, a building to the west.

## Description
Finally, you are of age, <name>... of age to battle in the name of the Horde. To conquer for the glory of the [Warchief](Warchief).

Yes...

<[Kaltunk](Kaltunk) looks you over.>
...
You will receive:
- 40 [XP](XP)
- +50 [reputation](reputation) with [Orgrimmar](Orgrimmar (faction))
- +50 [reputation](reputation) with [Darkspear Trolls](Darkspear Trolls (faction))
