...
url: "https://turtle-wow.fandom.com/wiki/Blackwing_Lair"
source_type: "community wiki (turtle-wow.fandom.com), not an official source"
revision: "2025-12-04T09:05:16Z"
fetched: "2026-09-10T07:38:26Z"
is_turtle_content: false
patch: null
categories: ["Blackrock Mountain", "Blackwing Lair", "Pages with broken file links", "Raids", "Stubs"]
---
# Blackwing Lair
...
To become attuned, you must first kill the [Scarshield Quartermaster](Scarshield Quartermaster) who is found near the Orb. Then, loot an item from him called [Blackhand's Command](Blackhand's Command) which begins a quest (all players in your raid can loot it). This quest requires that you go to the end of [Upper Blackrock Spire](Upper Blackrock Spire) and touch a brand (found behind [General Drakkisath](General Drakkisath). This will brand you with the Mark of Drakkisath and allow you to access the [Orb of Command](Orb of Command).

## Note
Blackwing Lair is one of toughest dungeons in WoW, and features some of the most intense and strategic fights in the entire game. It should only be attempted by guilds that have already mastered [Molten Core](Molten Core).

Once your guild has mastered [Blackwing Lair](Blackwing Lair), you are encouraged to attempt the [Temple of Ahn'Qiraj](Temple of Ahn'Qiraj).

## History
  *The mighty fortress carved within the fiery bowels of [Blackrock Mountain](Blackrock Mountain) was designed by the master dwarf-mason, [Franclorn Forgewright](Franclorn Forgewright). Intended to be the symbol of Dark Iron power, the fortress was held by the sinister dwarves for centuries. However, [Nefarian](Nefarian) - the cunning son of the dragon, [Deathwing](Deathwing) - had other plans for the great keep. He and his draconic minions took control of the upper Spire and made war on the dwarves' holdings in the mountain's volcanic depths, which serve as the seat of power for [Ragnaros the Firelord](Ragnaros). Ragnaros has uncovered the secret to creating life from stone and plans to build an army of unstoppable [golem](golem)s to aid him in conquering the whole of Blackrock Mountain.*
...
# Encounters
## Trash Mobs
- [Death Talon Pack](Death Talon Pack)s
- [Lab Pack](Lab Pack)s
...
## Loot
All remaining pieces of the [Tier 2](Tier 2) sets (head and pants drop from [Onyxia](Onyxia) and [Ragnaros](Ragnaros)), and much more Epic quality gear.
