---
title: "Enchanting"
url: "https://turtle-wow.fandom.com/wiki/Enchanting"
source_type: "community wiki (turtle-wow.fandom.com), not an official source"
revision: "2026-02-04T15:39:17Z"
...
## Training
Alliance learn [Expert Enchanting] from **[Kitta Firewind](https://database.turtlecraft.gg/?npc=11072)** in the tower of Azora, Horde learn it from **[Hgarth](https://database.turtlecraft.gg/?npc=11074)** in Stonetalon Mountains. Both learn [Artisan Enchanting] from **[Annora](https://database.turtlecraft.gg/?npc=11073)** in Uldaman.
{| class="fandom-table"
!Proficiency
!Level
!Skill
...
- [Strange Dust] - Disenchanted from level 1 to 20 items
- Level 11-15: Much strange dust
- [Soul Dust] - Disenchanted from level 21 to 30 items
- Level 26-30: Much soul dust
- [Vision Dust] - Disenchanted from level 31 to 40 items
- Level 36-40: Much vision dust
- [Dream Dust] - Disenchanted from level 41 to 50 items
- Level 46-50: Much dream dust
...
- [Lesser Magic Essence] - Disenchanted from level 1 to 10 items
- [Greater Magic Essence] - Disenchanted from level 11 to 15 items
- [Lesser Astral Essence] - Disenchanted from level 16 to 20 items (armor only)
- [Greater Astral Essence] - Disenchanted from level 21 to 25 items (armor only)
- [Lesser Mystic Essence] - Disenchanted from level 26 to 30 items
- [Greater Mystic Essence] - Disenchanted from level 31 to 35 items
- [Lesser Nether Essence] - Disenchanted from level 36 to 40 items
- [Greater Nether Essence] - Disenchanted from level 41 to 45 items
...
- [Small Glimmering Shard] - Disenchanted from level 1 to 20 items
- [Large Glimmering Shard] - Disenchanted from level 21 to 25 items
- [Small Glowing Shard] - Disenchanted from level 26 to 30 items
- [Large Glowing Shard] - Disenchanted from level 31 to 35 items
- [Small Radiant Shard] - Disenchanted from level 36 to 40 items
- [Large Radiant Shard] - Disenchanted from level 41 to 45 items
...
- [Nexus Crystal] - Disenchanted from level 51-60 items

## Enchanted Glows
Enchanters may enchant weapons for an additional bonus. Many of these enchants give off a glowing aura once the enchant is applied to the weapon.

- Check this link to learn what enchants applies glowing auras: [Glowchart](https://web.archive.org/web/20080406121914/http://www.glowchart.com/index.cfm?glows) 

## Recipes
- [ProfessionXLS.zip](https://web.archive.org/web/20060418002717if_/http://bollwerk.fileburst.com:80/ProfessionXLS.zip)
- [ProfessionPDF.zip](https://web.archive.org/web/20060418002712if_/http://bollwerk.fileburst.com:80/ProfessionPDF.zip)
- [Skillup Guide](https://web.archive.org/web/20060905163433/http://www.xs4all.nl/~brt/wow/guides/skillupenchanting.html)
...
|155 
|Lesser Mystic Wand
(Wand) Dmg: 23-43, Spd: 1.30, DPS: 25.4, MinLvl: 26
|1x Star Wood,
...
|175 
|Greater Mystic Wand
(Wand) Dmg: 40-76, Spd: 2.00, DPS: 29.0, MinLvl: 30
|1x Star Wood,
...
Permanently enchant a shield to give +2% chance to block.
...
[BoP] [U] (Trinket) AC: 150, FR: 7, NR: 7, CR: 7, SR: 7, MinLvl: 50
...
Permanently enchants bracers to increase the effects of your healing spells by 24.
|2x Large Brilliant Shard,
20x Illusion Dust,
4x Greater Eternal Essence,
6x Living Essence
...
Permanently enchant a Melee Weapon to add up to 55 points of healing to healing spells.
|4x Large Brilliant Shard,
8x Greater Eternal Essence,
6x Living Essence,
6x Essence of Water,
...
Permanently enchant a Melee Weapon to add up to 30 damage to spells.
|4x Large Brilliant Shard,
12x Greater Eternal Essence,
4x Essence of Fire,
4x Essence of Water,
