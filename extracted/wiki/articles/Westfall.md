---
title: "Westfall"
url: "https://turtle-wow.fandom.com/wiki/Westfall"
source_type: "community wiki (turtle-wow.fandom.com), not an official source"
revision: "2026-03-29T17:09:27Z"
fetched: "2026-09-10T07:40:00Z"
is_turtle_content: true
patch: "1.16.1"
categories: ["Eastern Kingdoms", "Grasslands", "Human territories", "Turtle WoW content", "Westfall"]
---
# Westfall
...
| level | 10 - 20 |
| capital | Moonbrook |
| races | Human, Gnoll, Kobold, Murloc |
| rulers | Edwin VanCleef, Gryan Stoutmantle |
| loc | Western Azeroth |
| major | Sentinel Hill |
...
The [People's Militia](People's Militia) has erected a last bastion of military power in the region at [Sentinel Hill](Sentinel Hill), from where they issue commands to anyone willing to aid the cause. Although most of the area's farms have fallen to disrepair and passed into control of the Defias, there are still a number of farmers who bravely and desperately cling to their holdings in spite of overwhelming odds.
...
There is one instanced dungeon - the [Deadmines](Deadmines), that can be found in Westfall. No other dungeons or battlegrounds can be found here.

The fastest way for an [Alliance](Alliance) character to get to [Yojamba Isle](Yojamba Isle) in [Stranglethorn](Stranglethorn) is by flying to [Sentinel Hill](Sentinel Hill), riding across Westfall, or swimming south around the bend.

### Maps and subregions
<gallery>
WorldMap-Westfall-old.jpg|Westfall prior to [patch 1.16.1](patch 1.16.1).
</gallery>
...
### Travel hubs
##### [Flight path](Flight path)s from [Sentinel Hill](Sentinel Hill)
...
|-
| [Elwynn Forest](Elwynn Forest) ||  || 1-10 || Northeast || By foot northeast or by flight path from [Sentinel Hill](Sentinel Hill) to [Stormwind City](Stormwind City)
|-
| [Duskwood](Duskwood) ||  || 18-30 || East || By foot east bridge or by flight path from [Sentinel Hill](Sentinel Hill) to [Darkshire](Darkshire).
|-
| [Balor](Balor) ||  || 29-34 || Northwest, across the sea || By swimming northwest from the coast, or by flight path from [Sentinel Hill](Sentinel Hill) to [SI:7 Outpost](SI:7 Outpost).
|-
| [Stranglethorn Vale](Stranglethorn Vale) ||  || 30-45 || South || By swimming southeast by river or southwest along the coast, or by flight path from [Sentinel Hill](Sentinel Hill) to [Booty Bay](Booty Bay).
|-
|}

## Resources
Dropped items in this area and their purpose:
- [Oil](Flask of Oil): Used for the Lighthouse quest just offshore from the southwest tip of Westfall;
- [Hops](Hops): Used for a brewing quest available south of Moonbrook in the Dagger Hills;
- [Goretusk Snout](Goretusk Snout), [Murloc Eye](Murloc Eye), [Stringy Vulture Meat](Stringy Vulture Meat): Used for Westfall Stew recipe at Saldean's Farm.
- [Okra](Okra): Needed for Westfall Stew quest, but not an actual ingredient in Westfall Stew.
...
## Wild creatures
- [Boar](Boar)s
- [Fleshripper](Fleshripper)s
- [Coyote](Coyote (mob))s
- [Crab](Crab)s
- [Dust Devil](Dust Devil)s
- [Foxes](Fox)
- [Ghoul](Ghoul)s
- [Gnoll](Gnoll)s
- [Harvest Watcher](Harvest Watcher)s
- [Kobold](Kobold)s
- [Murloc](Murloc)s
- [Shark](Shark)s
