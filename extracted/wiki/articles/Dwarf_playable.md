---
title: "Dwarf (playable)"
url: "https://turtle-wow.fandom.com/wiki/Dwarf_(playable)"
source_type: "community wiki (turtle-wow.fandom.com), not an official source"
revision: "2026-05-13T04:03:47Z"
fetched: "2026-09-10T07:38:42Z"
is_turtle_content: true
patch: "1.18.1"
categories: ["Alliance races", "Dwarves", "Ironforge", "Turtle WoW content"]
---
# Dwarf (playable)

*This article is about the playable race. For dwarf lore, see [Dwarf](Dwarf). For the in-game faction, see [Ironforge (faction)](Ironforge (faction)).*

The **dwarves** of [Ironforge](Ironforge (faction)) are one of the playable [Alliance](Alliance) races in *World of Warcraft*. They are an ancient race of robust humanoids who live beneath the snow-capped mountains of [Khaz Modan](Khaz Modan). These dwarves have always been fast allies to the humans and they revel in the prospects of battle and storytelling alike.

Dwarves start out in their snowy homeland, specifically in [Dun Morogh](Dun Morogh)'s [Coldridge Valley](Coldridge Valley). Their capital city is the mountain fortress of [Ironforge](Ironforge), which is where King [Magni Bronzebeard](Magni Bronzebeard) rules over Khaz Modan. The mount of choice for this stout folk is the [ram](ram). Whilst Dwarves speak the Common tongue of their human friends, their racial language is Dwarven. 
...
! style="text-align:left" |Stoneform - instant - 3 min cooldown
|-
|Immune to Bleed, Poison, and Disease. Reduces physical damage taken by 5%. Lasts 8 sec.||
|- class="alt"
! style="text-align:left" |Gun Specialization - passive
|-
|Skill with Guns increased by 3.||
|- class="alt"
! style="text-align:left" |Find Treasure - instant
|-
|Allows the dwarf to sense nearby treasure, making it appear on the minimap. Lasts until cancelled.||
|- class="alt"
! style="text-align:left" |Frost Resistance - passive
|-
