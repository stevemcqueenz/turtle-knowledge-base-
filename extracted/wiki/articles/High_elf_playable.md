---
title: "High elf (playable)"
url: "https://turtle-wow.fandom.com/wiki/High_elf_(playable)"
source_type: "community wiki (turtle-wow.fandom.com), not an official source"
revision: "2025-12-02T10:33:17Z"
fetched: "2026-09-10T07:38:59Z"
is_turtle_content: true
patch: "1.17.2"
categories: ["Alliance races", "High elves", "Turtle WoW content"]
---
# High elf (playable)

*This article is about the playable race. For the high elf lore, see [High elf](High elf). For the in-game faction, see [Silvermoon Remnant](Silvermoon Remnant).*

The **high elves** of [Quel'Thalas](Quel'Thalas (kingdom)) are one of the playable [Alliance](Alliance) races in *World of Warcraft*, introduced in Turtle WoW. They are a race descended from the night elf Highborne who left Kalimdor and settled in the Eastern Kingdoms, founding Quel'Thalas. The high elves were once a significant force on the continent, but in recent times their numbers have been dramatically reduced: most of their population was slaughtered during the Third War.

Formerly beginning their adventures at the Farstrider Lodge in Loch Modan, high elves now start in the [Thalassian Highlands](Thalassian Highlands), a remote region of their homeland that has been settled with the help of the Alliance. The outpost of [Alah'Thalas](Alah'Thalas), now expanded into a full settlement, serves as the capital of the high elves. Unicorns are their racial mount, and Thalassian is the language they speak, although they are also able to communicate with their allies by speaking Common. 
...
|- class="alt"
! style="text-align:left" |Enchanting Specialization - passive
|-
|Increases Enchanting skill by 15.||
|- class="alt"
! style="text-align:left" |Bow Specialization - passive
|-
|Skill with Bow Weapons increased by 3.||
|- class="alt"
! style="text-align:left" |Quel'dorei Meditation - 1.5 sec cast - 3 min cooldown
|-
|Generates 10% of your maximum mana, 20 rage, or 50 energy over 5 seconds. Warriors are considered in combat for the duration.||
|- class="alt"
|}
