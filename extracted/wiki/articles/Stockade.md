---
title: "Stockade"
url: "https://turtle-wow.fandom.com/wiki/Stockade"
source_type: "community wiki (turtle-wow.fandom.com), not an official source"
revision: "2025-12-29T07:32:31Z"
fetched: "2026-09-10T07:39:42Z"
is_turtle_content: false
patch: null
categories: ["Dungeons", "Eastern Kingdoms", "Human territories", "Prisons", "The Stockade"]
---
# Stockade
...
| name | The Stockade |
| aka | Stocks |
| ss | The Stockade loading screen.jpg |
| caption | The Stockade loading graphic |
| loc | Canals, Stormwind City |
| race | Human |
| boss | Bazil Thredd |
| level | 22-30 |
| minlevel | 15 |
...
It seems the prison was fairly inefficiently run, resorting to using least one [teenage guard](Mac) who got murdered when the prisoners revealed their allegiance to the [Defias Brotherhood](Defias Brotherhood). (ref: [quest: The Color of Blood]) Several prisoners were sentenced to death, including the [Blackrock](Blackrock clan) [orc](orc) [Targorr the Dread](Targorr the Dread) and human grave-robber [Dextren Ward](Dextren Ward), but [bureaucratic nobles](House of Nobles) put a hold on them in a sort of foul play. As a result, both the [Lakeshire](Lakeshire) guard, (ref: [quest: What Comes Around...]) [Council of Darkshire](Council of Darkshire) (ref: [quest: Crime and Punishment]) and even the [Kingdom of Ironforge](Ironforge (kingdom)) (ref: [quest: The Fury Runs Deep]) sent agents to the prison to bypass Stormwindian bureaucracy and have prisoners assassinated.

## Geography
<gallery>
WorldMap-TheStockade.jpg
</gallery>
...
| 
| [Dun Modr](Dun Modr), [Wetlands](Wetlands)
|-
