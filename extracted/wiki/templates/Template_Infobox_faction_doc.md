---
title: "Template:Infobox faction/doc"
url: "https://turtle-wow.fandom.com/wiki/Template:Infobox_faction/doc"
source_type: "community wiki (turtle-wow.fandom.com), not an official source"
revision: "2022-01-20T17:05:36Z"
fetched: "2026-09-10T07:40:24Z"
is_turtle_content: false
patch: null
categories: ["Pages with broken file links", "Pages with script errors", "Template documentation"]
---
# Template:Infobox faction/doc

| field | value |
|---|---|
| name | Cenarion Circle |
| image | nighthaven.jpg |
| caption | Nighthaven |
| faction | Neutral |
| leader |  |
| fleader | Elune |
| leaders | Anduin Wrynn |
| fleaders | Varian Wrynn |
| type | Kingdom / Empire |
| races | Cenarian |
| fraces |  |
| character | Druid |
...
| fcapital | Darnassus |
| capitals | Thunder Bluff |
| fcapitals | Suramar |
| base | Wailing Caverns |
| fbase | Cenarion Hold |
| theater | Darnassus, Felwood, Moonglade, Silithus, Thunder Bluff, Desolace, Ashenvale, Stonetalon Mountains |
| ftheater | Northrend |
| government | Anarchy |
| language | Darnassian |
| faith | Elune |
| members | Cenarion Expedition, D.E.H.T.A. |
| fmembers | Dark Iron clan |
| affiliation | Independent, Ancient Guardians |
| faffiliation | Burning Legion |
| status | Active |
| tokens | Coilfang Armaments |
| quartermaster | Fedryen Swiftspear |
| currency | Money |
| rewards | Defender of the Timbermaw |
...
- **Races:** races within the faction. Please use  separated by line breaks (use  if creatures aren't included)
